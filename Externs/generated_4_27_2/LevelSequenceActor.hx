...
extern class LevelSequenceActor extends Actor {
	...
	public var LevelSequence: SoftObjectPath;
...
abstract ConstLevelSequenceActor(LevelSequenceActor) from LevelSequenceActor {
	...
	public extern var LevelSequence(get, never): SoftObjectPath;
	public inline extern function get_LevelSequence(): SoftObjectPath return this.LevelSequence;
