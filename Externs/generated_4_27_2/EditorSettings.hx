...
extern class EditorSettings extends Object {
	...
	public var RecentlyOpenedProjectFiles: TArray<FString>;
...
abstract ConstEditorSettings(EditorSettings) from EditorSettings {
	...
	public extern var RecentlyOpenedProjectFiles(get, never): TArray<FString>;
	public inline extern function get_RecentlyOpenedProjectFiles(): TArray<FString> return this.RecentlyOpenedProjectFiles;
