...
extern class LightComponentBase extends SceneComp {
	...
	public var bCastRaytracedShadow: Bool;
...
abstract ConstLightComponentBase(LightComponentBase) from LightComponentBase {
	...
	public extern var bCastRaytracedShadow(get, never): Bool;
	public inline extern function get_bCastRaytracedShadow(): Bool return this.bCastRaytracedShadow;
