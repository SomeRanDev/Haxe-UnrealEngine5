...
extern class NiagaraComp extends FXSystemComp {
	...
	public var EmitterMaterials: TArray<NiagaraMaterialOverride>;
...
@:forward(
	IsPaused, GetTickBehavior, GetSeekDelta, GetRandomSeedOffset, GetPreviewLODDistanceEnabled,
	GetPreviewLODDistance, GetMaxSimTime, GetLockDesiredAgeDeltaTimeToSeekDelta, GetForceSolo, GetDesiredAge,
...
abstract ConstNiagaraComp(NiagaraComp) from NiagaraComp {
	...
	public extern var EmitterMaterials(get, never): TArray<NiagaraMaterialOverride>;
	public inline extern function get_EmitterMaterials(): TArray<NiagaraMaterialOverride> return this.EmitterMaterials;
