...
extern class Actor extends Object {
	...
	public var ControllingMatineeActors: TArray<cpp.Star<MatineeActor>>;
	...
	public function SnapRootComponentTo(InParentActor: cpp.Star<Actor>, InSocketName: FName): Void;
	...
	public function MakeMIDForMaterial(Parent: cpp.Star<MaterialInterface>): cpp.Reference<cpp.Star<MaterialInstanceDynamic>>;
	...
	public function K2_DestroyComponent(Component: cpp.Star<ActorComp>): Void;
	...
	public function GetAttachedActors(OutActors: cpp.Reference<TArray<cpp.Star<Actor>>>, bResetArray: Bool): Void;
	...
	public function GetActorLabel(): cpp.Reference<FString>;
...
@:forward(
	...
	GetRemoteRole, GetParentComponent, GetParentActor, GetOwner, GetOverlappingComponents,
	GetOverlappingActors, GetLocalRole, GetLifeSpan, GetInstigatorController, GetInstigator,
	GetInputVectorAxisValue, GetInputAxisValue, GetInputAxisKeyValue, GetHorizontalDotProductTo, GetHorizontalDistanceTo,
	GetGameTimeSinceCreation, GetFolderPath, GetDotProductTo, GetDistanceTo, GetComponentsByTag,
	GetComponentsByInterface, GetComponentByClass, GetAttachParentSocketName, GetAttachParentActor, GetAttachedActors,
	GetAllChildActors, GetActorUpVector, GetActorTimeDilation, GetActorTickInterval, GetActorScale3D,
	GetActorRightVector, GetActorRelativeScale3D, GetActorLabel, GetActorForwardVector, GetActorEyesViewPoint,
	GetActorEnableCollision, GetActorBounds, ActorHasTag
)
@:nativeGen
abstract ConstActor(Actor) from Actor {
	...
	public extern var ControllingMatineeActors(get, never): TArray<cpp.Star<MatineeActor.ConstMatineeActor>>;
	public inline extern function get_ControllingMatineeActors(): TArray<cpp.Star<MatineeActor.ConstMatineeActor>> return this.ControllingMatineeActors;
