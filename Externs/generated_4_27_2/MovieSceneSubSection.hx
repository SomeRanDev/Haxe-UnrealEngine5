...
extern class MovieSceneSubSection extends MovieSceneSection {
	...
	public var ActorToRecord: TLazyObjectPtr<Actor>;
	public var TargetSequenceName: FString;
	public var TargetPathToRecordTo: DirectoryPath;
...
abstract ConstMovieSceneSubSection(MovieSceneSubSection) from MovieSceneSubSection {
	...
	public extern var ActorToRecord(get, never): TLazyObjectPtr<Actor.ConstActor>;
	public inline extern function get_ActorToRecord(): TLazyObjectPtr<Actor.ConstActor> return this.ActorToRecord;
	public extern var TargetSequenceName(get, never): FString;
	public inline extern function get_TargetSequenceName(): FString return this.TargetSequenceName;
	public extern var TargetPathToRecordTo(get, never): DirectoryPath;
	public inline extern function get_TargetPathToRecordTo(): DirectoryPath return this.TargetPathToRecordTo;
}