...
extern class WindowsTargetSettings extends Object {
	...
	public var MinimumOSVersion: EMinimumSupportedOS;
...
abstract ConstWindowsTargetSettings(WindowsTargetSettings) from WindowsTargetSettings {
	...
	public extern var MinimumOSVersion(get, never): EMinimumSupportedOS;
	public inline extern function get_MinimumOSVersion(): EMinimumSupportedOS return this.MinimumOSVersion;
