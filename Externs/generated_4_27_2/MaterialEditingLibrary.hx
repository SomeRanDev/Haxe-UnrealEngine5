...
extern class MaterialEditingLibrary extends BlueprintFunctionLibrary {
	...
	public function SetMaterialInstanceVectorParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName, Value: LinearColor): cpp.Reference<Bool>;
	public function SetMaterialInstanceTextureParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName, Value: cpp.Star<Texture>): cpp.Reference<Bool>;
	public function SetMaterialInstanceScalarParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName, Value: cpp.Float32): cpp.Reference<Bool>;
	...
	public function GetMaterialInstanceVectorParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName): cpp.Reference<LinearColor>;
	public function GetMaterialInstanceTextureParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName): cpp.Reference<cpp.Star<Texture>>;
	public function GetMaterialInstanceStaticSwitchParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName): cpp.Reference<Bool>;
	public function GetMaterialInstanceScalarParameterValue(Instance: cpp.Star<MaterialInstanceConstant>, ParameterName: FName): cpp.Reference<cpp.Float32>;
