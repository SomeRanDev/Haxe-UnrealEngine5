...
extern class WorldSettings extends Info {
	...
	public var Pauser: cpp.Star<PlayerState>;
...
abstract ConstWorldSettings(WorldSettings) from WorldSettings {
	...
	public extern var bEnableHierarchicalLODSystem(get, never): Bool;
	public inline extern function get_bEnableHierarchicalLODSystem(): Bool return this.bEnableHierarchicalLODSystem;
	...
	public extern var Pauser(get, never): cpp.Star<PlayerState.ConstPlayerState>;
	public inline extern function get_Pauser(): cpp.Star<PlayerState.ConstPlayerState> return this.Pauser;
