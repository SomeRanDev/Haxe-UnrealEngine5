...
extern class KismetMathLibrary extends BlueprintFunctionLibrary {
	...
	public function VSizeXYSquared(A: Vector): cpp.Reference<cpp.Float32>;
	public function VSizeXY(A: Vector): cpp.Reference<cpp.Float32>;
	public function VSizeSquared(A: Vector): cpp.Reference<cpp.Float32>;
	public function VSize2DSquared(A: Vector2D): cpp.Reference<cpp.Float32>;
	public function VSize2D(A: Vector2D): cpp.Reference<cpp.Float32>;
	public function VSize(A: Vector): cpp.Reference<cpp.Float32>;
	...
	public function VectorSpringInterp(Current: Vector, Target: Vector, SpringState: cpp.Reference<VectorSpringState>, Stiffness: cpp.Float32, CriticalDampingFactor: cpp.Float32, DeltaTime: cpp.Float32, Mass: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Vector_Set(A: cpp.Reference<Vector>, X: cpp.Float32, Y: cpp.Float32, Z: cpp.Float32): Void;
	...
	public function Vector_HeadingAngle(A: Vector): cpp.Reference<cpp.Float32>;
	...
	public function Vector_GetAbsMin(A: Vector): cpp.Reference<cpp.Float32>;
	public function Vector_GetAbsMax(A: Vector): cpp.Reference<cpp.Float32>;
	...
	public function Vector_DistanceSquared(V1: Vector, V2: Vector): cpp.Reference<cpp.Float32>;
	public function Vector_Distance2DSquared(V1: Vector, V2: Vector): cpp.Reference<cpp.Float32>;
	public function Vector_Distance2D(V1: Vector, V2: Vector): cpp.Reference<cpp.Float32>;
	public function Vector_Distance(V1: Vector, V2: Vector): cpp.Reference<cpp.Float32>;
	public function Vector_CosineAngle2D(A: Vector, B: Vector): cpp.Reference<cpp.Float32>;
	...
	public function Vector_ClampSizeMax2D(A: Vector, Max: cpp.Float32): cpp.Reference<Vector>;
	public function Vector_ClampSizeMax(A: Vector, Max: cpp.Float32): cpp.Reference<Vector>;
	public function Vector_ClampSize2D(A: Vector, Min: cpp.Float32, Max: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Vector4_SizeSquared3(A: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	public function Vector4_SizeSquared(A: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	public function Vector4_Size3(A: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	public function Vector4_Size(A: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	public function Vector4_Set(A: cpp.Reference<Vector4>, X: cpp.Float32, Y: cpp.Float32, Z: cpp.Float32, W: cpp.Float32): Void;
	...
	public function Vector4_DotProduct3(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	public function Vector4_DotProduct(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): cpp.Reference<cpp.Float32>;
	...
	public function ToDirectionAndLength2D(A: Vector2D, OutDir: cpp.Reference<Vector2D>, OutLength: cpp.Reference<cpp.Float32>): Void;
	...
	public function Tan(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function Subtract_VectorFloat(A: Vector, B: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Subtract_Vector2DFloat(A: Vector2D, B: cpp.Float32): cpp.Reference<Vector2D>;
	...
	public function Subtract_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function Square(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Sqrt(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Spherical2DToUnitCartesian(A: Vector2D): cpp.Reference<Vector>;
	public function Sin(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function SignOfFloat(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function SetRandomStreamSeed(Stream: cpp.Reference<RandomStream>, NewSeed: cpp.Int32): Void;
	public function Set2D(A: cpp.Reference<Vector2D>, X: cpp.Float32, Y: cpp.Float32): Void;
	...
	public function SelectFloat(A: cpp.Float32, B: cpp.Float32, bPickA: Bool): cpp.Reference<cpp.Float32>;
	...
	public function SafeDivide(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Round64(A: cpp.Float32): cpp.Reference<cpp.Int64>;
	public function Round(A: cpp.Float32): cpp.Reference<cpp.Int32>;
	...
	public function RandomPointInBoundingBox(Origin: Vector, BoxExtent: Vector): cpp.Reference<Vector>;
	...
	public function RandomFloatInRange(Min: cpp.Float32, Max: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function RandomFloatFromStream(Stream: cpp.Reference<RandomStream>): cpp.Reference<cpp.Float32>;
	public function RandomFloat(): cpp.Reference<cpp.Float32>;
	...
	public function RadiansToDegrees(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function Percent_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function NotEqual_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function NormalizeToRange(Value: cpp.Float32, RangeMin: cpp.Float32, RangeMax: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function NearlyEqual_FloatFloat(A: cpp.Float32, B: cpp.Float32, ErrorTolerance: cpp.Float32): cpp.Reference<Bool>;
	public function MultiplyMultiply_FloatFloat(Base: cpp.Float32, Exp: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function MultiplyByPi(Value: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function Multiply_VectorFloat(A: Vector, B: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Multiply_Vector2DFloat(A: Vector2D, B: cpp.Float32): cpp.Reference<Vector2D>;
	...
	public function Multiply_MatrixFloat(A: cpp.Reference<Matrix>, B: cpp.Float32): cpp.Reference<Matrix>;
	...
	public function Multiply_IntFloat(A: cpp.Int32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Multiply_Int64Int64(A: cpp.Int64, B: cpp.Int64): cpp.Reference<cpp.Int64>;
	public function Multiply_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function MapRangeUnclamped(Value: cpp.Float32, InRangeA: cpp.Float32, InRangeB: cpp.Float32, OutRangeA: cpp.Float32, OutRangeB: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function MapRangeClamped(Value: cpp.Float32, InRangeA: cpp.Float32, InRangeB: cpp.Float32, OutRangeA: cpp.Float32, OutRangeB: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function MakeVector4(X: cpp.Float32, Y: cpp.Float32, Z: cpp.Float32, W: cpp.Float32): cpp.Reference<Vector4>;
	public function MakeVector2D(X: cpp.Float32, Y: cpp.Float32): cpp.Reference<Vector2D>;
	public function MakeVector(X: cpp.Float32, Y: cpp.Float32, Z: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Loge(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Log(A: cpp.Float32, Base: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function LessEqual_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function Less_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function Lerp(A: cpp.Float32, B: cpp.Float32, Alpha: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function InRange_FloatFloat(Value: cpp.Float32, Min: cpp.Float32, Max: cpp.Float32, InclusiveMin: Bool, InclusiveMax: Bool): cpp.Reference<Bool>;
	public function Hypotenuse(Width: cpp.Float32, Height: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function GridSnap_Float(Location: cpp.Float32, GridSize: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function GreaterEqual_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function Greater_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function GetTAU(): cpp.Reference<cpp.Float32>;
	...
	public function GetPI(): cpp.Reference<cpp.Float32>;
	...
	public function GetMinElement(A: Vector): cpp.Reference<cpp.Float32>;
	public function GetMin2D(A: Vector2D): cpp.Reference<cpp.Float32>;
	...
	public function GetMaxElement(A: Vector): cpp.Reference<cpp.Float32>;
	public function GetMax2D(A: Vector2D): cpp.Reference<cpp.Float32>;
	...
	public function GetAbsMax2D(A: Vector2D): cpp.Reference<cpp.Float32>;
	public function GetAbs2D(A: Vector2D): cpp.Reference<Vector2D>;
	public function FWrap(Value: cpp.Float32, Min: cpp.Float32, Max: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FTruncVector(InVector: cpp.Reference<Vector>): cpp.Reference<IntVector>;
	public function FTrunc64(A: cpp.Float32): cpp.Reference<cpp.Int64>;
	public function FTrunc(A: cpp.Float32): cpp.Reference<cpp.Int32>;
	...
	public function Fraction(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FMod(Dividend: cpp.Float32, Divisor: cpp.Float32, Remainder: cpp.Reference<cpp.Float32>): cpp.Reference<cpp.Int32>;
	public function FMin(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FMax(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FloatSpringInterp(Current: cpp.Float32, Target: cpp.Float32, SpringState: cpp.Reference<FloatSpringState>, Stiffness: cpp.Float32, CriticalDampingFactor: cpp.Float32, DeltaTime: cpp.Float32, Mass: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FixedTurn(InCurrent: cpp.Float32, InDesired: cpp.Float32, InDeltaRate: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FInterpTo_Constant(Current: cpp.Float32, Target: cpp.Float32, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FInterpTo(Current: cpp.Float32, Target: cpp.Float32, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FInterpEaseInOut(A: cpp.Float32, B: cpp.Float32, Alpha: cpp.Float32, Exponent: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function FFloor64(A: cpp.Float32): cpp.Reference<cpp.Int64>;
	public function FFloor(A: cpp.Float32): cpp.Reference<cpp.Int32>;
	public function FClamp(Value: cpp.Float32, Min: cpp.Float32, Max: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function FCeil64(A: cpp.Float32): cpp.Reference<cpp.Int64>;
	public function FCeil(A: cpp.Float32): cpp.Reference<cpp.Int32>;
	public function Exp(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function EqualEqual_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<Bool>;
	...
	public function Ease(A: cpp.Float32, B: cpp.Float32, Alpha: cpp.Float32, EasingFunc: EEasingFunc, BlendExp: cpp.Float32, Steps: cpp.Int32): cpp.Reference<cpp.Float32>;
	...
	public function DotProduct2D(A: Vector2D, B: Vector2D): cpp.Reference<cpp.Float32>;
	public function Dot_VectorVector(A: Vector, B: Vector): cpp.Reference<cpp.Float32>;
	...
	public function Divide_VectorFloat(A: Vector, B: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Divide_Vector2DFloat(A: Vector2D, B: cpp.Float32): cpp.Reference<Vector2D>;
	...
	public function Divide_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Divide_ByteByte(A: cpp.UInt8, B: cpp.UInt8): cpp.Reference<cpp.UInt8>;
	public function DistanceSquared2D(V1: Vector2D, V2: Vector2D): cpp.Reference<cpp.Float32>;
	public function Distance2D(V1: Vector2D, V2: Vector2D): cpp.Reference<cpp.Float32>;
	public function DegTan(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegSin(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegreesToRadians(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegCos(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegAtan2(Y: cpp.Float32, X: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegAtan(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegAsin(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function DegAcos(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function CrossProduct2D(A: Vector2D, B: Vector2D): cpp.Reference<cpp.Float32>;
	...
	public function Cos(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function ClampVectorSize(A: Vector, Min: cpp.Float32, Max: cpp.Float32): cpp.Reference<Vector>;
	...
	public function ClampAxes2D(A: Vector2D, MinAxisVal: cpp.Float32, MaxAxisVal: cpp.Float32): cpp.Reference<Vector2D>;
	public function ClampAngle(AngleDegrees: cpp.Float32, MinAngleDegrees: cpp.Float32, MaxAngleDegrees: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function BreakVector4(InVec: cpp.Reference<Vector4>, X: cpp.Reference<cpp.Float32>, Y: cpp.Reference<cpp.Float32>, Z: cpp.Reference<cpp.Float32>, W: cpp.Reference<cpp.Float32>): Void;
	public function BreakVector2D(InVec: Vector2D, X: cpp.Reference<cpp.Float32>, Y: cpp.Reference<cpp.Float32>): Void;
	public function BreakVector(InVec: Vector, X: cpp.Reference<cpp.Float32>, Y: cpp.Reference<cpp.Float32>, Z: cpp.Reference<cpp.Float32>): Void;
	...
	public function Atan2(Y: cpp.Float32, X: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Atan(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	public function Asin(A: cpp.Float32): cpp.Reference<cpp.Float32>;
	...
	public function Add_VectorFloat(A: Vector, B: cpp.Float32): cpp.Reference<Vector>;
	...
	public function Add_Vector2DFloat(A: Vector2D, B: cpp.Float32): cpp.Reference<Vector2D>;
	...
	public function Add_FloatFloat(A: cpp.Float32, B: cpp.Float32): cpp.Reference<cpp.Float32>;
