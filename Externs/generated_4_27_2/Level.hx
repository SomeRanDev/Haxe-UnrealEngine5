...
extern class Level extends Object {
	...
	public var bLevelOkayForPlacementWhileCheckedIn: Bool;
...
abstract ConstLevel(Level) from Level {
	...
	public extern var bLevelOkayForPlacementWhileCheckedIn(get, never): Bool;
	public inline extern function get_bLevelOkayForPlacementWhileCheckedIn(): Bool return this.bLevelOkayForPlacementWhileCheckedIn;
