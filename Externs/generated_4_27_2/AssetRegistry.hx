...
extern class AssetRegistry extends Interface {
	...
	public function ScanPathsSynchronous(InPaths: cpp.Reference<TArray<FString>>, bForceRescan: Bool): Void;
...
@:forward(
	UseFilterToExcludeAssets, RunAssetsThroughFilter, K2_GetReferencers, K2_GetDependencies, IsLoadingAssets,
	HasAssets, GetSubPaths, GetAssetsByPath, GetAssetsByPackageName, GetAssetsByClass,
	GetAssets, GetAssetByObjectPath, GetAllCachedPaths, GetAllAssets
)
@:nativeGen
