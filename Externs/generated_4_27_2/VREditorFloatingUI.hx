...
extern class VREditorFloatingUI extends VREditorBaseActor {
	...
	public var UserWidgetClass: cpp.Star<Class>;
}
...
abstract ConstVREditorFloatingUI(VREditorFloatingUI) from VREditorFloatingUI {
	...
	public extern var UserWidgetClass(get, never): cpp.Star<Class>;
	public inline extern function get_UserWidgetClass(): cpp.Star<Class> return this.UserWidgetClass;
}