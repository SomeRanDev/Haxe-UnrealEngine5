...
extern class AnimSequence extends AnimSequenceBase {
	...
	public var CustomAttributesGuid: Guid;
	public var BakedCustomAttributesGuid: Guid;
	public var BakedPerBoneCustomAttributeData: TArray<BakedCustomAttributePerBoneData>;
...
abstract ConstAnimSequence(AnimSequence) from AnimSequence {
	...
	public extern var CustomAttributesGuid(get, never): Guid;
	public inline extern function get_CustomAttributesGuid(): Guid return this.CustomAttributesGuid;
	public extern var BakedCustomAttributesGuid(get, never): Guid;
	public inline extern function get_BakedCustomAttributesGuid(): Guid return this.BakedCustomAttributesGuid;
	public extern var BakedPerBoneCustomAttributeData(get, never): TArray<BakedCustomAttributePerBoneData>;
	public inline extern function get_BakedPerBoneCustomAttributeData(): TArray<BakedCustomAttributePerBoneData> return this.BakedPerBoneCustomAttributeData;
}