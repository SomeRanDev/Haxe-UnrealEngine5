...
extern class InstancedStaticMeshComp extends StaticMeshComp {
	...
	public function AddInstances(InstanceTransforms: cpp.Reference<TArray<Transform>>, bShouldReturnIndices: Bool): cpp.Reference<TArray<cpp.Int32>>;
	public function AddInstance(InstanceTransform: cpp.Reference<Transform>): cpp.Reference<cpp.Int32>;
}

@:forward(GetInstanceTransform, GetInstancesOverlappingSphere, GetInstancesOverlappingBox, GetInstanceCount)
@:nativeGen
