...
extern class PawnMovementComp extends NavMovementComp {
	...
	public function K2_GetInputVector(): cpp.Reference<Vector>;
...
@:forward(K2_GetInputVector, IsMoveInputIgnored, GetPendingInputVector, GetPawnOwner, GetLastInputVector)
@:nativeGen
