...
extern class PrimitiveComp extends SceneComp {
	...
	public var bUseMaxLODAsImposter: Bool;
	public var bBatchImpostersAsInstances: Bool;
	...
	public var LpvBiasMultiplier: cpp.Float32;
	...
	public function SetPhysicsMaxAngularVelocity(NewMaxAngVel: cpp.Float32, bAddToCurrent: Bool, BoneName: FName): Void;
	...
	public function SetPhysicsAngularVelocity(NewAngVel: Vector, bAddToCurrent: Bool, BoneName: FName): Void;
	...
	public function GetPhysicsAngularVelocity(BoneName: FName): cpp.Reference<Vector>;
	...
	public function AddTorque(Torque: Vector, BoneName: FName, bAccelChange: Bool): Void;
	...
	public function AddAngularImpulse(Impulse: Vector, BoneName: FName, bVelChange: Bool): Void;
}
...
@:forward(
	...
	GetPhysicsAngularVelocityInDegrees, GetPhysicsAngularVelocity, GetOverlappingComponents, GetOverlappingActors, GetNumMaterials,
	GetMaterialFromCollisionFaceIndex, GetMaterial, GetMassScale, GetMass, GetLinearDamping,
	GetInertiaTensor, GetGenerateOverlapEvents, GetCollisionResponseToChannel, GetCollisionProfileName, GetCollisionObjectType,
...
abstract ConstPrimitiveComp(PrimitiveComp) from PrimitiveComp {
	...
	public extern var bUseMaxLODAsImposter(get, never): Bool;
	public inline extern function get_bUseMaxLODAsImposter(): Bool return this.bUseMaxLODAsImposter;
	public extern var bBatchImpostersAsInstances(get, never): Bool;
	public inline extern function get_bBatchImpostersAsInstances(): Bool return this.bBatchImpostersAsInstances;
	...
	public extern var LpvBiasMultiplier(get, never): cpp.Float32;
	public inline extern function get_LpvBiasMultiplier(): cpp.Float32 return this.LpvBiasMultiplier;
