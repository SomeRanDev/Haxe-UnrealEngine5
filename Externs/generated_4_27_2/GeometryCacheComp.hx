...
@:forward(
	IsPlayingReversed, IsPlaying, IsLooping, IsExtrapolatingFrames, GetStartTimeOffset,
	GetPlaybackSpeed, GetPlaybackDirection, GetNumberOfFrames, GetMotionVectorScale, GetDuration,
	GetAnimationTime
)
@:nativeGen
