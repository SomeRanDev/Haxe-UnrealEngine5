...
extern class CookerSettings extends DeveloperSettings {
	...
	public var DefaultPVRTCQuality: cpp.Int32;
...
abstract ConstCookerSettings(CookerSettings) from CookerSettings {
	...
	public extern var DefaultPVRTCQuality(get, never): cpp.Int32;
	public inline extern function get_DefaultPVRTCQuality(): cpp.Int32 return this.DefaultPVRTCQuality;
