...
abstract ConstDirectionalLightComp(DirectionalLightComp) from DirectionalLightComp {
	...
	public extern var bUsedAsAtmosphereSunLight(get, never): Bool;
	public inline extern function get_bUsedAsAtmosphereSunLight(): Bool return this.bUsedAsAtmosphereSunLight;
