...
extern class DetailsView extends PropertyViewBase {
	...
	public var bShowOnlyWhitelisted: Bool;
}
...
abstract ConstDetailsView(DetailsView) from DetailsView {
	...
	public extern var bShowOnlyWhitelisted(get, never): Bool;
	public inline extern function get_bShowOnlyWhitelisted(): Bool return this.bShowOnlyWhitelisted;
}