...
extern class LevelVariantSetsActor extends Actor {
	...
	public var DirectorInstances: TMap<cpp.Star<Class>, cpp.Star<LevelVariantSetsFunctionDirector>>;
...
abstract ConstLevelVariantSetsActor(LevelVariantSetsActor) from LevelVariantSetsActor {
	...
	public extern var DirectorInstances(get, never): TMap<cpp.Star<Class>, cpp.Star<LevelVariantSetsFunctionDirector.ConstLevelVariantSetsFunctionDirector>>;
	public inline extern function get_DirectorInstances(): TMap<cpp.Star<Class>, cpp.Star<LevelVariantSetsFunctionDirector.ConstLevelVariantSetsFunctionDirector>> return this.DirectorInstances;
}