...
extern class StaticMesh extends StreamableRenderAsset {
	...
	public var bIsBuiltAtRuntime: Bool;
	...
	public var LODForOccluderMesh: cpp.Int32;
	...
	public var EditableMesh: cpp.Star<Object>;
	...
	public function BuildFromStaticMeshDescriptions(StaticMeshDescriptions: cpp.Reference<TArray<cpp.Star<StaticMeshDescription>>>, bBuildSimpleCollision: Bool): Void;
...
@:forward(
	GetStaticMaterials, GetNumSections, GetNumLODs, GetMinimumLODForPlatforms, GetMinimumLODForPlatform,
...
abstract ConstStaticMesh(StaticMesh) from StaticMesh {
	...
	public extern var bIsBuiltAtRuntime(get, never): Bool;
	public inline extern function get_bIsBuiltAtRuntime(): Bool return this.bIsBuiltAtRuntime;
	...
	public extern var LODForOccluderMesh(get, never): cpp.Int32;
	public inline extern function get_LODForOccluderMesh(): cpp.Int32 return this.LODForOccluderMesh;
	...
	public extern var EditableMesh(get, never): cpp.Star<Object.ConstObject>;
	public inline extern function get_EditableMesh(): cpp.Star<Object.ConstObject> return this.EditableMesh;
