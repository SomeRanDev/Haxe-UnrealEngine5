...
extern class HierarchicalLODSettings extends DeveloperSettings {
	...
	public var bInvalidateHLODClusters: Bool;
	public var bDeleteHLODAssets: Bool;
...
abstract ConstHierarchicalLODSettings(HierarchicalLODSettings) from HierarchicalLODSettings {
	...
	public extern var bInvalidateHLODClusters(get, never): Bool;
	public inline extern function get_bInvalidateHLODClusters(): Bool return this.bInvalidateHLODClusters;
	public extern var bDeleteHLODAssets(get, never): Bool;
	public inline extern function get_bDeleteHLODAssets(): Bool return this.bDeleteHLODAssets;
