...
extern class AnimInstance extends Object {
	...
	public var DeltaTime_DEPRECATED: cpp.Float32;
	public var bRunUpdatesInWorkerThreads_DEPRECATED: Bool;
	public var bCanUseParallelUpdateAnimation_DEPRECATED: Bool;
	public var bWarnAboutBlueprintUsage_DEPRECATED: Bool;
	...
	public function PlaySlotAnimation(Asset: cpp.Star<AnimSequenceBase>, SlotNodeName: FName, BlendInTime: cpp.Float32, BlendOutTime: cpp.Float32, InPlayRate: cpp.Float32, LoopCount: cpp.Int32): cpp.Reference<cpp.Float32>;
...
@:forward(
	...
	Montage_GetIsStopped, Montage_GetCurrentSection, Montage_GetBlendTime, IsSyncGroupBetweenMarkers, IsPlayingSlotAnimation,
	IsAnyMontagePlaying, HasMarkerBeenHitThisFrame, GetTimeToClosestMarker, GetSyncGroupPosition, GetReceiveNotifiesFromLinkedInstances,
	GetPropagateNotifiesToLinkedInstances, GetOwningComponent, GetOwningActor, GetLinkedAnimLayerInstancesByGroup, GetLinkedAnimLayerInstanceByGroupAndClass,
	GetLinkedAnimLayerInstanceByGroup, GetLinkedAnimLayerInstanceByClass, GetLinkedAnimGraphInstancesByTag, GetLinkedAnimGraphInstanceByTag, GetCurveValue,
	GetCurrentActiveMontage, GetAllCurveNames, GetActiveCurveNames, CalculateDirection
)
@:nativeGen
abstract ConstAnimInstance(AnimInstance) from AnimInstance {
	...
	public extern var DeltaTime_DEPRECATED(get, never): cpp.Float32;
	public inline extern function get_DeltaTime_DEPRECATED(): cpp.Float32 return this.DeltaTime_DEPRECATED;
	public extern var bRunUpdatesInWorkerThreads_DEPRECATED(get, never): Bool;
	public inline extern function get_bRunUpdatesInWorkerThreads_DEPRECATED(): Bool return this.bRunUpdatesInWorkerThreads_DEPRECATED;
	public extern var bCanUseParallelUpdateAnimation_DEPRECATED(get, never): Bool;
	public inline extern function get_bCanUseParallelUpdateAnimation_DEPRECATED(): Bool return this.bCanUseParallelUpdateAnimation_DEPRECATED;
	public extern var bWarnAboutBlueprintUsage_DEPRECATED(get, never): Bool;
	public inline extern function get_bWarnAboutBlueprintUsage_DEPRECATED(): Bool return this.bWarnAboutBlueprintUsage_DEPRECATED;
