...
extern class Controller extends Actor {
	...
	public function CastToPlayerController(): cpp.Reference<cpp.Star<PlayerController>>;
}

@:forward(
	LineOfSightTo, K2_GetPawn, IsPlayerController, IsMoveInputIgnored, IsLookInputIgnored,
	IsLocalPlayerController, IsLocalController, GetViewTarget, GetDesiredRotation, GetControlRotation
)
@:nativeGen
