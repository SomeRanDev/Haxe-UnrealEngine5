...
@:native("USequenceCameraShakeCameraStandIn")
@:include("SequenceCameraShake.h")
extern class SequenceCameraShakeCameraStandIn extends Object {
...
@:forward()
@:nativeGen
abstract ConstSequenceCameraShakeCameraStandIn(SequenceCameraShakeCameraStandIn) from SequenceCameraShakeCameraStandIn {
