...
extern class AssetManager extends Object {
	...
	public var bIsBulkScanning: Bool;
...
abstract ConstAssetManager(AssetManager) from AssetManager {
	...
	public extern var bIsBulkScanning(get, never): Bool;
	public inline extern function get_bIsBulkScanning(): Bool return this.bIsBulkScanning;
