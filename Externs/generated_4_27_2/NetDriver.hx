...
extern class NetDriver extends Object {
	...
	public var NetConnectionClass: cpp.Star<Class>;
	public var ReplicationDriverClass: cpp.Star<Class>;
...
abstract ConstNetDriver(NetDriver) from NetDriver {
	...
	public extern var NetConnectionClass(get, never): cpp.Star<Class>;
	public inline extern function get_NetConnectionClass(): cpp.Star<Class> return this.NetConnectionClass;
	public extern var ReplicationDriverClass(get, never): cpp.Star<Class>;
	public inline extern function get_ReplicationDriverClass(): cpp.Star<Class> return this.ReplicationDriverClass;
	...
	public extern var Time(get, never): cpp.Float32;
	public inline extern function get_Time(): cpp.Float32 return this.Time;
