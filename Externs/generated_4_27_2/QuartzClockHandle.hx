...
extern class QuartzClockHandle extends Object {
	public var QuartzSubsystem: cpp.Star<QuartzSubsystem>;
	public var WorldPtr: cpp.Star<World>;
...
abstract ConstQuartzClockHandle(QuartzClockHandle) from QuartzClockHandle {
	public extern var QuartzSubsystem(get, never): cpp.Star<QuartzSubsystem.ConstQuartzSubsystem>;
	public inline extern function get_QuartzSubsystem(): cpp.Star<QuartzSubsystem.ConstQuartzSubsystem> return this.QuartzSubsystem;
	public extern var WorldPtr(get, never): cpp.Star<World.ConstWorld>;
	public inline extern function get_WorldPtr(): cpp.Star<World.ConstWorld> return this.WorldPtr;
}