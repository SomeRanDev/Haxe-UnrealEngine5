...
extern class ObjectLibrary extends Object {
	public var ObjectBaseClass: cpp.Star<Class>;
...
abstract ConstObjectLibrary(ObjectLibrary) from ObjectLibrary {
	public extern var ObjectBaseClass(get, never): cpp.Star<Class>;
	public inline extern function get_ObjectBaseClass(): cpp.Star<Class> return this.ObjectBaseClass;
