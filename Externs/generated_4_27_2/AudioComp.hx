...
extern class AudioComp extends SceneComp {
	...
	public var InstanceParameters: TArray<AudioComponentParam>;
...
abstract ConstAudioComp(AudioComp) from AudioComp {
	...
	public extern var InstanceParameters(get, never): TArray<AudioComponentParam>;
	public inline extern function get_InstanceParameters(): TArray<AudioComponentParam> return this.InstanceParameters;
