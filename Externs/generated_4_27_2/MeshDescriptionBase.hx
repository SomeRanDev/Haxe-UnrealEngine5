...
extern class MeshDescriptionBase extends Object {
	...
	public function SetPolygonVertexInstance(PolygonID: PolygonID, PerimeterIndex: cpp.Int32, VertexInstanceID: VertexInstanceID): Void;
...
@:forward(
	...
	GetVertexInstancePairEdge, GetVertexInstanceForTriangleVertex, GetVertexInstanceForPolygonVertex, GetVertexInstanceConnectedTriangles, GetVertexInstanceConnectedPolygons,
	GetVertexConnectedTriangles, GetVertexConnectedPolygons, GetVertexConnectedEdges, GetVertexAdjacentVertices, GetTriangleVertices,
	GetTriangleVertexInstances, GetTriangleVertexInstance, GetTrianglePolygonGroup, GetTrianglePolygon, GetTriangleEdges,
	GetTriangleAdjacentTriangles, GetPolygonVertices, GetPolygonVertexInstances, GetPolygonTriangles, GetPolygonPolygonGroup,
	GetPolygonPerimeterEdges, GetPolygonInternalEdges, GetPolygonGroupPolygons, GetPolygonAdjacentPolygons, GetNumVertexVertexInstances,
	...
	GetNumEdgeConnectedPolygons, GetEdgeVertices, GetEdgeVertex, GetEdgeConnectedTriangles, GetEdgeConnectedPolygons
)
@:nativeGen
