...
abstract DistributionVectorParticleParameterPtr(ucpp.Ptr<DistributionVectorParticleParameter>) from ucpp.Ptr<DistributionVectorParticleParameter> to ucpp.Ptr<DistributionVectorParticleParameter>{
	@:from
