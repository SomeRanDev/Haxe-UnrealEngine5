...
extern class RigVMController extends Object {
	...
	public function UpgradeNodes(InNodeNames: cpp.Reference<TArray<FName>>, bRecursive: Bool, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): TArray<cpp.Star<RigVMNode>>;
	public function UnresolveTemplateNodes(InNodeNames: cpp.Reference<TArray<FName>>, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	public function Undo(): Bool;
	public function UnbindPinFromVariable(InPinPath: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	public function SetUnitNodeDefaults(InNode: cpp.Star<RigVMUnitNode>, InDefaults: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	...
	public function SetLocalVariableDefaultValue(InVariableName: cpp.Reference<FName>, InDefaultValue: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	...
	public function ResolveWildCardPin(InPinPath: FString, InCPPType: FString, InCPPTypeObjectPath: cpp.Reference<FName>, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	...
	public function PerformUserWorkflow(InWorkflow: cpp.Reference<RigVMUserWorkflow>, InOptions: cpp.Star<RigVMUserWorkflowOptions.ConstRigVMUserWorkflowOptions>, bSetupUndoRedo: Bool): Bool;
	public function OpenUndoBracket(InTitle: FString): Bool;
	public function MarkFunctionAsPublic(InFunctionName: cpp.Reference<FName>, bInIsPublic: Bool, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): Bool;
	...
	public function MakeOptionsForWorkflow(InSubject: cpp.Star<Object>, InWorkflow: cpp.Reference<RigVMUserWorkflow>): cpp.Star<RigVMUserWorkflowOptions>;
	...
	public function LocalizeFunctions(InFunctionDefinitions: TArray<RigVMGraphFunctionIdentifier>, bLocalizeDependentPrivateFunctions: Bool, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): TMap<RigVMGraphFunctionIdentifier, cpp.Star<RigVMLibraryNode>>;
	public function LocalizeFunctionFromPath(InHostPath: FString, InFunctionName: cpp.Reference<FName>, bLocalizeDependentPrivateFunctions: Bool, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMLibraryNode>;
	public function LocalizeFunction(InFunctionDefinition: cpp.Reference<RigVMGraphFunctionIdentifier>, bLocalizeDependentPrivateFunctions: Bool, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMLibraryNode>;
	public function IsReportingEnabled(): Bool;
	public function IsFunctionPublic(InFunctionName: cpp.Reference<FName>): Bool;
	...
	public function GetUnitStructsForTemplate(InNotation: cpp.Reference<FName>): TArray<cpp.Star<ScriptStruct>>;
	public function GetTopLevelGraph(): cpp.Star<RigVMGraph>;
	public function GetTemplateForUnitStruct(InFunction: cpp.Star<ScriptStruct>, InMethodName: FString): FString;
	public function GetRegisteredUnitStructs(): TArray<cpp.Star<ScriptStruct>>;
	...
	public function CollapseNodes(InNodeNames: cpp.Reference<TArray<FName>>, InCollapseNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool, bIsAggregate: Bool): cpp.Star<RigVMCollapseNode>;
	...
	public function AddUnitNodeWithDefaults(InScriptStruct: cpp.Star<ScriptStruct>, InDefaults: FString, InMethodName: cpp.Reference<FName>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMUnitNode>;
	...
	public function AddTemplateNode(InNotation: cpp.Reference<FName>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMTemplateNode>;
	public function AddSelectNodeFromStruct(InScriptStruct: cpp.Star<ScriptStruct>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool): cpp.Star<RigVMNode>;
	public function AddSelectNode(InCPPType: FString, InCPPTypeObjectPath: cpp.Reference<FName>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMNode>;
	...
	public function AddInvokeEntryNode(InEntryName: cpp.Reference<FName>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMInvokeEntryNode>;
	...
	public function AddIfNodeFromStruct(InScriptStruct: cpp.Star<ScriptStruct>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool): cpp.Star<RigVMNode>;
	public function AddIfNode(InCPPType: FString, InCPPTypeObjectPath: cpp.Reference<FName>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMNode>;
	...
	public function AddFunctionReferenceNodeFromDescription(InFunctionDefinition: cpp.Reference<RigVMGraphFunctionHeader>, InNodePosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool, bAllowPrivateFunctions: Bool): cpp.Star<RigVMFunctionReferenceNode>;
	...
	public function AddExternalFunctionReferenceNode(InHostPath: FString, InFunctionName: cpp.Reference<FName>, InNodePosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMFunctionReferenceNode>;
	...
	public function AddBranchNode(InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool): cpp.Star<RigVMNode>;
	...
	public function AddArrayNodeFromObjectPath(InOpCode: ERigVMOpCode, InCPPType: FString, InCPPTypeObjectPath: FString, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool, bIsPatching: Bool): cpp.Star<RigVMNode>;
	public function AddArrayNode(InOpCode: ERigVMOpCode, InCPPType: FString, InCPPTypeObject: cpp.Star<Object>, InPosition: cpp.Reference<Vector2D>, InNodeName: FString, bSetupUndoRedo: Bool, bPrintPythonCommand: Bool, bIsPatching: Bool): cpp.Star<RigVMNode>;
