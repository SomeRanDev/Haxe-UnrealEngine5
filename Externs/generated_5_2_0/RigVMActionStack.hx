...
extern class RigVMActionStack extends Object {
	...
	public function CloseUndoBracket(InController: cpp.Star<RigVMController>): Bool;
	public function CancelUndoBracket(InController: cpp.Star<RigVMController>): Bool;
