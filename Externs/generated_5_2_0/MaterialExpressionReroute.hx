...
abstract MaterialExpressionReroutePtr(ucpp.Ptr<MaterialExpressionReroute>) from ucpp.Ptr<MaterialExpressionReroute> to ucpp.Ptr<MaterialExpressionReroute>{
	@:from
