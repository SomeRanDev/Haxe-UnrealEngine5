...
extern class AnimNode_MultiWayBlend extends AnimNode_Base {
	...
	@:native("FAnimNode_MultiWayBlend") public static function make(Poses: TArray<PoseLink>, DesiredAlphas: TArray<cpp.Float32>, AlphaScaleBias: InputScaleBias, bAdditiveNode: Bool, bNormalizeAlpha: Bool): AnimNode_MultiWayBlend ;
}