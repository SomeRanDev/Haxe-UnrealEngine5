...
abstract K2Node_SetAttributeKeyGenericPtr(cpp.Star<K2Node_SetAttributeKeyGeneric>) from cpp.Star<K2Node_SetAttributeKeyGeneric> to cpp.Star<K2Node_SetAttributeKeyGeneric>{
	@:from
