...
extern class AssetTools extends Interface {
	...
	public function MigratePackages(PackageNamesToMigrate: cpp.Reference<TArray<FName>>, DestinationPath: FString, Options: cpp.Reference<MigrationOptions>): Void;
	...
	public function DiffAssets(OldAsset: cpp.Star<Object>, NewAsset: cpp.Star<Object>, OldRevision: cpp.Reference<RevisionInfo>, NewRevision: cpp.Reference<RevisionInfo>): Void;
	public function DiffAgainstDepot(InObject: cpp.Star<Object>, InPackagePath: FString, InPackageName: FString): Void;
	...
	public function BeginAdvancedCopyPackages(InputNamesToCopy: cpp.Reference<TArray<FName>>, TargetPath: FString, OnCopyComplete: cpp.Reference<HaxeDelegateProperty<(Bool, cpp.Reference<TArray<AssetRenameData>>) -> Void>>): Void;
