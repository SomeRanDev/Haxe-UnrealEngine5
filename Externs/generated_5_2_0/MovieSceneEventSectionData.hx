...
extern class MovieSceneEventSectionData extends MovieSceneChannel {
	...
	@:native("FMovieSceneEventSectionData") public static function make(Times: TArray<FrameNumber>, KeyValues: TArray<EventPayload>, KeyHandles: MovieSceneKeyHandleMap, KeyTimes_DEPRECATED: TArray<cpp.Float32>): MovieSceneEventSectionData ;
}