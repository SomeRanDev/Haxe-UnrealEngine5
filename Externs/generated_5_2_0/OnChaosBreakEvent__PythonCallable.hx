...
@:forward()
@:nativeGen
abstract ConstOnChaosBreakEvent__PythonCallable(OnChaosBreakEvent__PythonCallable) from OnChaosBreakEvent__PythonCallable {
}
...
abstract OnChaosBreakEvent__PythonCallablePtr(cpp.Star<OnChaosBreakEvent__PythonCallable>) from cpp.Star<OnChaosBreakEvent__PythonCallable> to cpp.Star<OnChaosBreakEvent__PythonCallable>{
	...
	@:to
	public extern inline function asValue(): OnChaosBreakEvent__PythonCallable {
