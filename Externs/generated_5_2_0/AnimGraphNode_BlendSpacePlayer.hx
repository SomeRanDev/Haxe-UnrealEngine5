...
abstract AnimGraphNode_BlendSpacePlayerPtr(cpp.Star<AnimGraphNode_BlendSpacePlayer>) from cpp.Star<AnimGraphNode_BlendSpacePlayer> to cpp.Star<AnimGraphNode_BlendSpacePlayer>{
	@:from
