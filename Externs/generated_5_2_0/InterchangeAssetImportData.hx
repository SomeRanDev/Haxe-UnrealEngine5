...
extern class InterchangeAssetImportData extends AssetImportData {
	...
	public var Pipelines: TArray<cpp.Star<Object>>;
...
abstract ConstInterchangeAssetImportData(InterchangeAssetImportData) from InterchangeAssetImportData {
	...
	public extern var Pipelines(get, never): TArray<cpp.Star<Object.ConstObject>>;
	public inline extern function get_Pipelines(): TArray<cpp.Star<Object.ConstObject>> return this.Pipelines;
}
