...
abstract AssetDefinition_SoundAttenuationPtr(cpp.Star<AssetDefinition_SoundAttenuation>) from cpp.Star<AssetDefinition_SoundAttenuation> to cpp.Star<AssetDefinition_SoundAttenuation>{
	@:from
