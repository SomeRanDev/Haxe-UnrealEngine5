...
abstract ParticleModuleRotationRate_SeededPtr(ucpp.Ptr<ParticleModuleRotationRate_Seeded>) from ucpp.Ptr<ParticleModuleRotationRate_Seeded> to ucpp.Ptr<ParticleModuleRotationRate_Seeded>{
	@:from
