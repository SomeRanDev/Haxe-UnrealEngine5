...
@:native("UMaterialExpressionOut")
@:include("MaterialX/MaterialExpressionOut.h")
@:structAccess
extern class MaterialExpressionOut extends MaterialExpression {
...
@:forward()
@:nativeGen
abstract ConstMaterialExpressionOut(MaterialExpressionOut) from MaterialExpressionOut {
...
@:forward
@:nativeGen
@:native("MaterialExpressionOut*")
abstract MaterialExpressionOutPtr(cpp.Star<MaterialExpressionOut>) from cpp.Star<MaterialExpressionOut> to cpp.Star<MaterialExpressionOut>{
	@:from
	public static extern inline function fromValue(v: MaterialExpressionOut): MaterialExpressionOutPtr {
		return untyped __cpp__("&({0})", v);
	}

	@:to
	public extern inline function asValue(): MaterialExpressionOut {
