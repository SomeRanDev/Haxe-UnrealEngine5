...
abstract GenerateDistillFileSetsCommandletPtr(ucpp.Ptr<GenerateDistillFileSetsCommandlet>) from ucpp.Ptr<GenerateDistillFileSetsCommandlet> to ucpp.Ptr<GenerateDistillFileSetsCommandlet>{
	@:from
