...
abstract ControlRigTemplateNodeSpawnerPtr(ucpp.Ptr<ControlRigTemplateNodeSpawner>) from ucpp.Ptr<ControlRigTemplateNodeSpawner> to ucpp.Ptr<ControlRigTemplateNodeSpawner>{
	@:from
