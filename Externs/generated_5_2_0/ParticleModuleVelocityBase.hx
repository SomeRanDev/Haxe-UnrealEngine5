...
abstract ParticleModuleVelocityBasePtr(ucpp.Ptr<ParticleModuleVelocityBase>) from ucpp.Ptr<ParticleModuleVelocityBase> to ucpp.Ptr<ParticleModuleVelocityBase>{
	@:from
