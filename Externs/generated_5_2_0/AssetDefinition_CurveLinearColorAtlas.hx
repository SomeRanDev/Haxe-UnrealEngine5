...
abstract AssetDefinition_CurveLinearColorAtlasPtr(ucpp.Ptr<AssetDefinition_CurveLinearColorAtlas>) from ucpp.Ptr<AssetDefinition_CurveLinearColorAtlas> to ucpp.Ptr<AssetDefinition_CurveLinearColorAtlas>{
	@:from
