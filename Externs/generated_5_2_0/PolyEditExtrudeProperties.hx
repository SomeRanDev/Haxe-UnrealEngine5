...
abstract PolyEditExtrudePropertiesPtr(ucpp.Ptr<PolyEditExtrudeProperties>) from ucpp.Ptr<PolyEditExtrudeProperties> to ucpp.Ptr<PolyEditExtrudeProperties>{
	@:from
