...
abstract MaterialExpressionSceneDepthPtr(ucpp.Ptr<MaterialExpressionSceneDepth>) from ucpp.Ptr<MaterialExpressionSceneDepth> to ucpp.Ptr<MaterialExpressionSceneDepth>{
	@:from
