...
extern class GameplayTasksComp extends ActorComp {
	...
	private var SimulatedTasks: TArray<cpp.Star<GameplayTask>>;

	public function OnRep_SimulatedTasks(PreviousSimulatedTasks: cpp.Reference<TArray<cpp.Star<GameplayTask>>>): Void;
