...
abstract NetObjectPrioritizerConfigPtr(cpp.Star<NetObjectPrioritizerConfig>) from cpp.Star<NetObjectPrioritizerConfig> to cpp.Star<NetObjectPrioritizerConfig>{
	@:from
