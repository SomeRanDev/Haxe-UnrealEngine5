...
@:native("UMaterialExpressionPlus")
@:include("MaterialX/MaterialExpressionPlus.h")
@:structAccess
extern class MaterialExpressionPlus extends MaterialExpression {
...
@:forward()
@:nativeGen
abstract ConstMaterialExpressionPlus(MaterialExpressionPlus) from MaterialExpressionPlus {
...
@:forward
@:nativeGen
@:native("MaterialExpressionPlus*")
abstract MaterialExpressionPlusPtr(cpp.Star<MaterialExpressionPlus>) from cpp.Star<MaterialExpressionPlus> to cpp.Star<MaterialExpressionPlus>{
	@:from
	public static extern inline function fromValue(v: MaterialExpressionPlus): MaterialExpressionPlusPtr {
		return untyped __cpp__("&({0})", v);
	}

	@:to
	public extern inline function asValue(): MaterialExpressionPlus {
