...
abstract UVEditorBaseTransformToolBuilderPtr(ucpp.Ptr<UVEditorBaseTransformToolBuilder>) from ucpp.Ptr<UVEditorBaseTransformToolBuilder> to ucpp.Ptr<UVEditorBaseTransformToolBuilder>{
	@:from
