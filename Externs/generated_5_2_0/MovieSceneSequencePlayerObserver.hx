...
abstract MovieSceneSequencePlayerObserverPtr(cpp.Star<MovieSceneSequencePlayerObserver>) from cpp.Star<MovieSceneSequencePlayerObserver> to cpp.Star<MovieSceneSequencePlayerObserver>{
	@:from
