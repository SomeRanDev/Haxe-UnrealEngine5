...
extern class NavigationTestingActor extends Actor {
	...
	public var PathCost: cpp.Float64;
...
abstract ConstNavigationTestingActor(NavigationTestingActor) from NavigationTestingActor {
	...
	public extern var PathCost(get, never): cpp.Float64;
	public inline extern function get_PathCost(): cpp.Float64 return this.PathCost;
