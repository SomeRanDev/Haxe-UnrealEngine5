...
extern class NetConnection extends Player {
	...
	public var DefaultMaxChannelSize: cpp.Int32;
...
abstract ConstNetConnection(NetConnection) from NetConnection {
	...
	public extern var DefaultMaxChannelSize(get, never): cpp.Int32;
	public inline extern function get_DefaultMaxChannelSize(): cpp.Int32 return this.DefaultMaxChannelSize;
}
