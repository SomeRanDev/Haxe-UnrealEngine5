...
@:forward()
@:nativeGen
abstract ConstDiscardedMemoryClassTemplate_1(DiscardedMemoryClassTemplate_1) from DiscardedMemoryClassTemplate_1 {
...
abstract DiscardedMemoryClassTemplate_1Ptr(ucpp.Ptr<DiscardedMemoryClassTemplate_1>) from ucpp.Ptr<DiscardedMemoryClassTemplate_1> to ucpp.Ptr<DiscardedMemoryClassTemplate_1>{
	...
	@:to
	public extern inline function asValue(): DiscardedMemoryClassTemplate_1 {
