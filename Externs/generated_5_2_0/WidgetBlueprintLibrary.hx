...
extern class WidgetBlueprintLibrary extends BlueprintFunctionLibrary {
	...
	public function SetInputMode_UIOnlyEx(PlayerController: cpp.Star<PlayerController>, InWidgetToFocus: cpp.Star<Widget>, InMouseLockMode: EMouseLockMode, bFlushInput: Bool): Void;
	public function SetInputMode_GameOnly(PlayerController: cpp.Star<PlayerController>, bFlushInput: Bool): Void;
	public function SetInputMode_GameAndUIEx(PlayerController: cpp.Star<PlayerController>, InWidgetToFocus: cpp.Star<Widget>, InMouseLockMode: EMouseLockMode, bHideCursorDuringCapture: Bool, bFlushInput: Bool): Void;
	...
	public function DrawSpline(Context: cpp.Reference<PaintContext>, Start: Vector2D, StartDir: Vector2D, End: Vector2D, EndDir: Vector2D, Tint: LinearColor, Thickness: cpp.Float32): Void;
