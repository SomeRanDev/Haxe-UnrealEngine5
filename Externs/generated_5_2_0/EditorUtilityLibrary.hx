...
extern class EditorUtilityLibrary extends BlueprintFunctionLibrary {
	public function SyncBrowserToFolders(FolderList: cpp.Reference<TArray<FString>>): Void;
	...
	public function GetSelectedAssetsOfClass(AssetClass: cpp.Star<Class>): TArray<cpp.Star<Object>>;
