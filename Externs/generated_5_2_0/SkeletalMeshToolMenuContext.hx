...
abstract SkeletalMeshToolMenuContextPtr(ucpp.Ptr<SkeletalMeshToolMenuContext>) from ucpp.Ptr<SkeletalMeshToolMenuContext> to ucpp.Ptr<SkeletalMeshToolMenuContext>{
	@:from
