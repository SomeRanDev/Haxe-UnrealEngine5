...
extern class MaterialInstanceDynamic extends MaterialInstance {
	...
	public function SetSparseVolumeTextureParameterValue(ParameterName: FName, Value: cpp.Star<SparseVolumeTexture>): Void;
	...
	public function SetScalarParameterByIndex(ParameterIndex: cpp.Int32, Value: cpp.Float32): Bool;
	...
	public function InitializeScalarParameterAndGetIndex(ParameterName: cpp.Reference<FName>, Value: cpp.Float32, OutParameterIndex: cpp.Reference<cpp.Int32>): Bool;
