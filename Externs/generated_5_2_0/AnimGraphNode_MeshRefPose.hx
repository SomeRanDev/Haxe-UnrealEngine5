...
abstract AnimGraphNode_MeshRefPosePtr(ucpp.Ptr<AnimGraphNode_MeshRefPose>) from ucpp.Ptr<AnimGraphNode_MeshRefPose> to ucpp.Ptr<AnimGraphNode_MeshRefPose>{
	@:from
