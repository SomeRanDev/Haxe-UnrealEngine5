...
extern class NiagaraOutliner extends Object {
	...
	public var SystemSimCaches: TMap<FName, cpp.Star<NiagaraSimCache>>;
...
abstract ConstNiagaraOutliner(NiagaraOutliner) from NiagaraOutliner {
	...
	public extern var SystemSimCaches(get, never): TMap<FName, cpp.Star<NiagaraSimCache.ConstNiagaraSimCache>>;
	public inline extern function get_SystemSimCaches(): TMap<FName, cpp.Star<NiagaraSimCache.ConstNiagaraSimCache>> return this.SystemSimCaches;
}
