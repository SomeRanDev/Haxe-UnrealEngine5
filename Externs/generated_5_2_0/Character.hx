...
extern class Character extends Pawn {
	...
	public var LandedDelegate: HaxeMulticastSparseDelegateProperty<(cpp.Reference<HitResult>) -> Void>;
...
abstract ConstCharacter(Character) from Character {
	...
	public extern var LandedDelegate(get, never): HaxeMulticastSparseDelegateProperty<(cpp.Reference<HitResult>) -> Void>;
	public inline extern function get_LandedDelegate(): HaxeMulticastSparseDelegateProperty<(cpp.Reference<HitResult>) -> Void> return this.LandedDelegate;
