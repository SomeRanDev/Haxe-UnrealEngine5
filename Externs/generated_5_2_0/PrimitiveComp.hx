...
extern class PrimitiveComp extends SceneComp {
	...
	public var OnComponentPhysicsStateChanged: HaxeMulticastSparseDelegateProperty<(cpp.Star<PrimitiveComp>, EComponentPhysicsStateChange) -> Void>;
	...
	public var OnInputTouchBegin: HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp>) -> Void>;
	public var OnInputTouchEnd: HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp>) -> Void>;
	public var OnInputTouchEnter: HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp>) -> Void>;
	public var OnInputTouchLeave: HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp>) -> Void>;
	...
	private var ExcludeFromHLODLevels: cpp.UInt8;
	private var LODParentPrimitive: cpp.Star<PrimitiveComp>;
	...
	private function SetExcludeForSpecificHLODLevels(InExcludeForSpecificHLODLevels: cpp.Reference<TArray<cpp.Int32>>): Void;
	...
	public function K2_SphereTraceComponent(TraceStart: Vector, TraceEnd: Vector, SphereRadius: cpp.Float32, bTraceComplex: Bool, bShowTrace: Bool, bPersistentShowTrace: Bool, HitLocation: cpp.Reference<Vector>, HitNormal: cpp.Reference<Vector>, BoneName: cpp.Reference<FName>, OutHit: cpp.Reference<HitResult>): Bool;
	public function K2_SphereOverlapComponent(InSphereCentre: Vector, InSphereRadius: cpp.Float32, bTraceComplex: Bool, bShowTrace: Bool, bPersistentShowTrace: Bool, HitLocation: cpp.Reference<Vector>, HitNormal: cpp.Reference<Vector>, BoneName: cpp.Reference<FName>, OutHit: cpp.Reference<HitResult>): Bool;
	public function K2_LineTraceComponent(TraceStart: Vector, TraceEnd: Vector, bTraceComplex: Bool, bShowTrace: Bool, bPersistentShowTrace: Bool, HitLocation: cpp.Reference<Vector>, HitNormal: cpp.Reference<Vector>, BoneName: cpp.Reference<FName>, OutHit: cpp.Reference<HitResult>): Bool;
	...
	public function K2_BoxOverlapComponent(InBoxCentre: Vector, InBox: Box, bTraceComplex: Bool, bShowTrace: Bool, bPersistentShowTrace: Bool, HitLocation: cpp.Reference<Vector>, HitNormal: cpp.Reference<Vector>, BoneName: cpp.Reference<FName>, OutHit: cpp.Reference<HitResult>): Bool;
	public function IsOverlappingComponent(OtherComp: cpp.Star<PrimitiveComp.ConstPrimitiveComp>): Bool;
	...
	public function GetMaterialFromCollisionFaceIndex(FaceIndex: cpp.Int32, SectionIndex: cpp.Reference<cpp.Int32>): cpp.Star<MaterialInterface>;
	public function GetMaterial(ElementIndex: cpp.Int32): cpp.Star<MaterialInterface>;
	...
	private function GetExcludeForSpecificHLODLevels(): TArray<cpp.Int32>;
	...
	public function GetClosestPointOnCollision(Point: cpp.Reference<Vector>, OutPointOnBody: cpp.Reference<Vector>, BoneName: FName): cpp.Float32;
	public function GetCenterOfMass(BoneName: FName): Vector;
	public function GetBodyInstanceAsyncPhysicsTickHandle(BoneName: FName, bGetWelded: Bool, Index: cpp.Int32): BodyInstanceAsyncPhysicsTickHandle;
	public function GetAngularDamping(): cpp.Float32;
	public function CreateDynamicMaterialInstance(ElementIndex: cpp.Int32, SourceMaterial: cpp.Star<MaterialInterface>, OptionalName: FName): cpp.Star<MaterialInstanceDynamic>;
	public function CreateAndSetMaterialInstanceDynamicFromMaterial(ElementIndex: cpp.Int32, Parent: cpp.Star<MaterialInterface>): cpp.Star<MaterialInstanceDynamic>;
	public function CreateAndSetMaterialInstanceDynamic(ElementIndex: cpp.Int32): cpp.Star<MaterialInstanceDynamic>;
	public function CopyArrayOfMoveIgnoreComponents(): TArray<cpp.Star<PrimitiveComp>>;
	public function CopyArrayOfMoveIgnoreActors(): TArray<cpp.Star<Actor>>;
	public function ClearMoveIgnoreComponents(): Void;
	public function ClearMoveIgnoreActors(): Void;
	public function CanCharacterStepUp(Pawn: cpp.Star<Pawn>): Bool;
	...
	public function AddRadialImpulse(Origin: Vector, Radius: cpp.Float32, Strength: cpp.Float32, Falloff: TEnumAsByte<ERadialImpulseFalloff>, bVelChange: Bool): Void;
	public function AddRadialForce(Origin: Vector, Radius: cpp.Float32, Strength: cpp.Float32, Falloff: TEnumAsByte<ERadialImpulseFalloff>, bAccelChange: Bool): Void;
...
abstract ConstPrimitiveComp(PrimitiveComp) from PrimitiveComp {
	...
	public extern var OnComponentPhysicsStateChanged(get, never): HaxeMulticastSparseDelegateProperty<(cpp.Star<PrimitiveComp.ConstPrimitiveComp>, EComponentPhysicsStateChange) -> Void>;
	public inline extern function get_OnComponentPhysicsStateChanged(): HaxeMulticastSparseDelegateProperty<(cpp.Star<PrimitiveComp.ConstPrimitiveComp>, EComponentPhysicsStateChange) -> Void> return this.OnComponentPhysicsStateChanged;
	...
	public extern var OnInputTouchBegin(get, never): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void>;
	public inline extern function get_OnInputTouchBegin(): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void> return this.OnInputTouchBegin;
	public extern var OnInputTouchEnd(get, never): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void>;
	public inline extern function get_OnInputTouchEnd(): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void> return this.OnInputTouchEnd;
	public extern var OnInputTouchEnter(get, never): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void>;
	public inline extern function get_OnInputTouchEnter(): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void> return this.OnInputTouchEnter;
	public extern var OnInputTouchLeave(get, never): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void>;
	public inline extern function get_OnInputTouchLeave(): HaxeMulticastSparseDelegateProperty<(TEnumAsByte<ETouchIndex>, cpp.Star<PrimitiveComp.ConstPrimitiveComp>) -> Void> return this.OnInputTouchLeave;
