...
@:native("UDiscardedMemoryClassTemplate_0")
@:valueType
extern class DiscardedMemoryClassTemplate_0 extends RigVMMemoryStorage {
...
@:forward()
@:nativeGen
abstract ConstDiscardedMemoryClassTemplate_0(DiscardedMemoryClassTemplate_0) from DiscardedMemoryClassTemplate_0 {
...
@:forward
@:nativeGen
@:native("DiscardedMemoryClassTemplate_0*")
abstract DiscardedMemoryClassTemplate_0Ptr(ucpp.Ptr<DiscardedMemoryClassTemplate_0>) from ucpp.Ptr<DiscardedMemoryClassTemplate_0> to ucpp.Ptr<DiscardedMemoryClassTemplate_0>{
	@:from
	public static extern inline function fromValue(v: DiscardedMemoryClassTemplate_0): DiscardedMemoryClassTemplate_0Ptr {
		return untyped __cpp__("&({0})", v);
	}

	@:to
	public extern inline function asValue(): DiscardedMemoryClassTemplate_0 {
