...
extern class NiagaraDataInterfaceChaosDestruction extends NiagaraDataInterface {
	public var ChaosSolverActorSet: TSet<ucpp.Ptr<ChaosSolverActor>>;
	public var DataSourceType: EDataSourceTypeEnum;
	public var DataProcessFrequency: ucpp.num.Int32;
	public var MaxNumberOfDataEntriesToSpawn: ucpp.num.Int32;
	public var DoSpawn: Bool;
	public var SpawnMultiplierMinMax: Vector2D;
	public var SpawnChance: ucpp.num.Float32;
	...
	public var SurfaceTypeToSpawn: ucpp.num.Int32;
	...
	public var TrailMinSpeedToSpawn: ucpp.num.Float32;
	...
	public var MaxDataPerCell: ucpp.num.Int32;
	public var bApplyMaterialsFilter: Bool;
	public var ChaosBreakingMaterialSet: TSet<ucpp.Ptr<PhysicalMaterial>>;
	...
	public var InheritedVelocityMultiplier: ucpp.num.Float32;
	...
	public var SpreadAngleMax: ucpp.num.Float32;
	public var VelocityOffsetMin: Vector;
	public var VelocityOffsetMax: Vector;
	public var FinalVelocityMagnitudeMinMax: Vector2D;
	public var MaxLatency: ucpp.num.Float32;
	public var DebugType: EDebugTypeEnum;
	@:protected public var LastSpawnedPointID: ucpp.num.Int32;
	@:protected public var LastSpawnTime: ucpp.num.Float32;
	@:protected public var SolverTime: ucpp.num.Float32;
	@:protected public var TimeStampOfLastProcessedData: ucpp.num.Float32;
...
abstract ConstNiagaraDataInterfaceChaosDestruction(NiagaraDataInterfaceChaosDestruction) from NiagaraDataInterfaceChaosDestruction {
	public extern var ChaosSolverActorSet(get, never): TSet<ucpp.Ptr<ChaosSolverActor.ConstChaosSolverActor>>;
	public inline extern function get_ChaosSolverActorSet(): TSet<ucpp.Ptr<ChaosSolverActor.ConstChaosSolverActor>> return this.ChaosSolverActorSet;
	...
	public extern var DataProcessFrequency(get, never): ucpp.num.Int32;
	public inline extern function get_DataProcessFrequency(): ucpp.num.Int32 return this.DataProcessFrequency;
	public extern var MaxNumberOfDataEntriesToSpawn(get, never): ucpp.num.Int32;
	public inline extern function get_MaxNumberOfDataEntriesToSpawn(): ucpp.num.Int32 return this.MaxNumberOfDataEntriesToSpawn;
	...
	public extern var SpawnChance(get, never): ucpp.num.Float32;
	public inline extern function get_SpawnChance(): ucpp.num.Float32 return this.SpawnChance;
	...
	public extern var SurfaceTypeToSpawn(get, never): ucpp.num.Int32;
	public inline extern function get_SurfaceTypeToSpawn(): ucpp.num.Int32 return this.SurfaceTypeToSpawn;
	...
	public extern var TrailMinSpeedToSpawn(get, never): ucpp.num.Float32;
	public inline extern function get_TrailMinSpeedToSpawn(): ucpp.num.Float32 return this.TrailMinSpeedToSpawn;
	...
	public extern var MaxDataPerCell(get, never): ucpp.num.Int32;
	public inline extern function get_MaxDataPerCell(): ucpp.num.Int32 return this.MaxDataPerCell;
	...
	public extern var ChaosBreakingMaterialSet(get, never): TSet<ucpp.Ptr<PhysicalMaterial.ConstPhysicalMaterial>>;
	public inline extern function get_ChaosBreakingMaterialSet(): TSet<ucpp.Ptr<PhysicalMaterial.ConstPhysicalMaterial>> return this.ChaosBreakingMaterialSet;
	...
	public extern var InheritedVelocityMultiplier(get, never): ucpp.num.Float32;
	public inline extern function get_InheritedVelocityMultiplier(): ucpp.num.Float32 return this.InheritedVelocityMultiplier;
	...
	public extern var SpreadAngleMax(get, never): ucpp.num.Float32;
	public inline extern function get_SpreadAngleMax(): ucpp.num.Float32 return this.SpreadAngleMax;
	...
	public extern var MaxLatency(get, never): ucpp.num.Float32;
	public inline extern function get_MaxLatency(): ucpp.num.Float32 return this.MaxLatency;
...
abstract NiagaraDataInterfaceChaosDestructionPtr(ucpp.Ptr<NiagaraDataInterfaceChaosDestruction>) from ucpp.Ptr<NiagaraDataInterfaceChaosDestruction> to ucpp.Ptr<NiagaraDataInterfaceChaosDestruction>{
	@:from
