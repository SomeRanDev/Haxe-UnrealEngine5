...
extern class CameraRig_Rail extends Actor {
	...
	@:protected public var TransformComponent: cpp.Star<SceneComp>;
	@:protected public var RailSplineComponent: cpp.Star<SplineComp>;
	@:protected public var RailCameraMount: cpp.Star<SceneComp>;
