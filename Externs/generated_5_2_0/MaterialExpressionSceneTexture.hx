...
abstract MaterialExpressionSceneTexturePtr(ucpp.Ptr<MaterialExpressionSceneTexture>) from ucpp.Ptr<MaterialExpressionSceneTexture> to ucpp.Ptr<MaterialExpressionSceneTexture>{
	@:from
