...
extern class AnimInstance extends Object {
	...
	public function RequestTransitionEvent(EventName: FName, RequestTimeout: cpp.Float64, QueueMode: ETransitionRequestQueueMode, OverwriteMode: ETransitionRequestOverwriteMode): Bool;
	public function RequestSlotGroupInertialization(InSlotGroupName: FName, Duration: cpp.Float32, BlendProfile: cpp.Star<BlendProfile.ConstBlendProfile>): Void;
	public function RemovePoseSnapshot(SnapshotName: FName): Void;
	public function QueryTransitionEvent(MachineIndex: cpp.Int32, TransitionIndex: cpp.Int32, EventName: FName): Bool;
	public function QueryAndMarkTransitionEvent(MachineIndex: cpp.Int32, TransitionIndex: cpp.Int32, EventName: FName): Bool;
	...
	public function Montage_GetEffectivePlayRate(Montage: cpp.Star<AnimMontage.ConstAnimMontage>): cpp.Float32;
	...
	public function GetCurveValueWithDefault(CurveName: FName, DefaultValue: cpp.Float32, OutValue: cpp.Reference<cpp.Float32>): Bool;
