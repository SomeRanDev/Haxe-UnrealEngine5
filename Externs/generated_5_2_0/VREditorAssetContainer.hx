...
extern class VREditorAssetContainer extends DataAsset {
	...
	public var WidgetMaterial: cpp.Star<MaterialInterface>;
	public var CameraWidgetMaterial: cpp.Star<MaterialInterface>;
...
abstract ConstVREditorAssetContainer(VREditorAssetContainer) from VREditorAssetContainer {
	...
	public extern var WidgetMaterial(get, never): cpp.Star<MaterialInterface.ConstMaterialInterface>;
	public inline extern function get_WidgetMaterial(): cpp.Star<MaterialInterface.ConstMaterialInterface> return this.WidgetMaterial;
	public extern var CameraWidgetMaterial(get, never): cpp.Star<MaterialInterface.ConstMaterialInterface>;
	public inline extern function get_CameraWidgetMaterial(): cpp.Star<MaterialInterface.ConstMaterialInterface> return this.CameraWidgetMaterial;
