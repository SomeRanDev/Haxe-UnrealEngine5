...
abstract UniformScaleGizmoHandleGroupPtr(ucpp.Ptr<UniformScaleGizmoHandleGroup>) from ucpp.Ptr<UniformScaleGizmoHandleGroup> to ucpp.Ptr<UniformScaleGizmoHandleGroup>{
	@:from
