...
abstract PaperTiledImporterFactoryPtr(cpp.Star<PaperTiledImporterFactory>) from cpp.Star<PaperTiledImporterFactory> to cpp.Star<PaperTiledImporterFactory>{
	@:from
