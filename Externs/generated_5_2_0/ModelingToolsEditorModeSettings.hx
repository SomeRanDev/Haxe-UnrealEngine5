...
abstract ModelingToolsEditorModeSettingsPtr(ucpp.Ptr<ModelingToolsEditorModeSettings>) from ucpp.Ptr<ModelingToolsEditorModeSettings> to ucpp.Ptr<ModelingToolsEditorModeSettings>{
	@:from
