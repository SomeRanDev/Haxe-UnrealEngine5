...
@:forward()
@:nativeGen
abstract ConstObjectMixerEditorSerializedData(ObjectMixerEditorSerializedData) from ObjectMixerEditorSerializedData {
	public extern var SerializedDataPerFilter(get, never): TSet<ObjectMixerSerializationDataPerFilter>;
	public inline extern function get_SerializedDataPerFilter(): TSet<ObjectMixerSerializationDataPerFilter> return this.SerializedDataPerFilter;
}
...
abstract ObjectMixerEditorSerializedDataPtr(ucpp.Ptr<ObjectMixerEditorSerializedData>) from ucpp.Ptr<ObjectMixerEditorSerializedData> to ucpp.Ptr<ObjectMixerEditorSerializedData>{
	...
	@:to
	public extern inline function asValue(): ObjectMixerEditorSerializedData {
