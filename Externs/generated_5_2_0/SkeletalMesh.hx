...
extern class SkeletalMesh extends SkinnedAsset {
	...
	public function GetMorphTargetsPtrConv(): TArray<cpp.Star<MorphTarget>>;
	...
	@:protected public var DefaultMeshDeformer: cpp.Star<MeshDeformer>;
	...
	public function AddSocket(InSocket: cpp.Star<SkeletalMeshSocket>, bAddToSkeleton: Bool): Void;
