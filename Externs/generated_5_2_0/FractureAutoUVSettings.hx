...
extern class FractureAutoUVSettings extends FractureToolSettings {
	...
	public var bAutoFitToBounds: Bool;
	public var bUniformProjectionScale: Bool;
...
abstract ConstFractureAutoUVSettings(FractureAutoUVSettings) from FractureAutoUVSettings {
	...
	public extern var bAutoFitToBounds(get, never): Bool;
	public inline extern function get_bAutoFitToBounds(): Bool return this.bAutoFitToBounds;
	public extern var bUniformProjectionScale(get, never): Bool;
	public inline extern function get_bUniformProjectionScale(): Bool return this.bUniformProjectionScale;
	public extern var ProjectionUVOffset(get, never): Vector2D;
	public inline extern function get_ProjectionUVOffset(): Vector2D return this.ProjectionUVOffset;
	public extern var bCenterAtPivot(get, never): Bool;
