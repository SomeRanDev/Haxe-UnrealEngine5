...
extern class SourceControlHelpers extends Object {
	...
	public function RevertAndReloadPackages(InPackagesToRevert: cpp.Reference<TArray<FString>>, bRevertAll: Bool, bReloadWorld: Bool): Bool;
	...
	public function CheckInFiles(InFiles: cpp.Reference<TArray<FString>>, InDescription: FString, bSilent: Bool, bKeepCheckedOut: Bool): Bool;
