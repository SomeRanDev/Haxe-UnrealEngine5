...
@:forward()
@:nativeGen
abstract ConstMaterialExpressionVolumetricCloudEmptySpaceSkippingOutput(MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput) from MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput {
	public extern var ContainsMatter(get, never): ExpressionInput;
	public inline extern function get_ContainsMatter(): ExpressionInput return this.ContainsMatter;
}
...
abstract MaterialExpressionVolumetricCloudEmptySpaceSkippingOutputPtr(cpp.Star<MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput>) from cpp.Star<MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput> to cpp.Star<MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput>{
	...
	@:to
	public extern inline function asValue(): MaterialExpressionVolumetricCloudEmptySpaceSkippingOutput {
