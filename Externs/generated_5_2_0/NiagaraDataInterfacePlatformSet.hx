...
abstract NiagaraDataInterfacePlatformSetPtr(cpp.Star<NiagaraDataInterfacePlatformSet>) from cpp.Star<NiagaraDataInterfacePlatformSet> to cpp.Star<NiagaraDataInterfacePlatformSet>{
	@:from
