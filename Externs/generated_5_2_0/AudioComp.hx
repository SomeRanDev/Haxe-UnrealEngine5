...
extern class AudioComp extends SceneComp {
	...
	public function SetModulationRouting(Modulators: cpp.Reference<TSet<cpp.Star<SoundModulatorBase>>>, Destination: EModulationDestination, RoutingMethod: EModulationRouting): Void;
	...
	public function GetModulators(Destination: EModulationDestination): TSet<cpp.Star<SoundModulatorBase>>;
