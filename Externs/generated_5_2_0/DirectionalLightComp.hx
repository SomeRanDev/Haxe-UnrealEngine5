...
extern class DirectionalLightComp extends LightComp {
	...
	public var ForwardShadingPriority: cpp.Int32;
	...
	public function SetForwardShadingPriority(NewValue: cpp.Int32): Void;
...
abstract ConstDirectionalLightComp(DirectionalLightComp) from DirectionalLightComp {
	...
	public extern var ForwardShadingPriority(get, never): cpp.Int32;
	public inline extern function get_ForwardShadingPriority(): cpp.Int32 return this.ForwardShadingPriority;
