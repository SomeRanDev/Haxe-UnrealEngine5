...
extern class KismetMathLibrary extends BlueprintFunctionLibrary {
	...
	public function WeightedMovingAverage_FVector(CurrentSample: Vector, PreviousSample: Vector, Weight: cpp.Float32): Vector;
	public function WeightedMovingAverage_FRotator(CurrentSample: Rotator, PreviousSample: Rotator, Weight: cpp.Float32): Rotator;
	...
	public function VSizeXYSquared(A: Vector): cpp.Float64;
	public function VSizeXY(A: Vector): cpp.Float64;
	public function VSizeSquared(A: Vector): cpp.Float64;
	public function VSize2DSquared(A: Vector2D): cpp.Float64;
	public function VSize2D(A: Vector2D): cpp.Float64;
	public function VSize(A: Vector): cpp.Float64;
	public function VLerp(A: Vector, B: Vector, Alpha: cpp.Float32): Vector;
	public function VInterpTo_Constant(Current: Vector, Target: Vector, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Vector;
	public function VInterpTo(Current: Vector, Target: Vector, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Vector;
	...
	public function Vector_SnappedToGrid(InVect: Vector, InGridSize: cpp.Float32): Vector;
	public function Vector_SlerpVectorToDirection(Vector: Vector, Direction: Vector, Alpha: cpp.Float64): Vector;
	public function Vector_SlerpNormals(NormalA: Vector, NormalB: Vector, Alpha: cpp.Float64): Vector;
	...
	public function Vector_Reciprocal(A: cpp.Reference<Vector>): Vector;
	public function Vector_ProjectOnToNormal(V: Vector, InNormal: Vector): Vector;
	public function Vector_One(): Vector;
	public function Vector_NormalUnsafe(A: cpp.Reference<Vector>): Vector;
	public function Vector_Normalize(A: cpp.Reference<Vector>, Tolerance: cpp.Float32): Void;
	public function Vector_Normal2D(A: Vector, Tolerance: cpp.Float32): Vector;
	public function Vector_MirrorByPlane(A: Vector, InPlane: cpp.Reference<Plane>): Vector;
	public function Vector_Left(): Vector;
	public function Vector_IsZero(A: cpp.Reference<Vector>): Bool;
	public function Vector_IsUnit(A: cpp.Reference<Vector>, SquaredLenthTolerance: cpp.Float32): Bool;
	public function Vector_IsUniform(A: cpp.Reference<Vector>, Tolerance: cpp.Float32): Bool;
	public function Vector_IsNormal(A: cpp.Reference<Vector>): Bool;
	public function Vector_IsNearlyZero(A: cpp.Reference<Vector>, Tolerance: cpp.Float32): Bool;
	public function Vector_IsNAN(A: cpp.Reference<Vector>): Bool;
	public function Vector_HeadingAngle(A: Vector): cpp.Float64;
	public function Vector_GetSignVector(A: Vector): Vector;
	public function Vector_GetProjection(A: Vector): Vector;
	public function Vector_GetAbsMin(A: Vector): cpp.Float64;
	public function Vector_GetAbsMax(A: Vector): cpp.Float64;
	public function Vector_GetAbs(A: Vector): Vector;
	public function Vector_Forward(): Vector;
	public function Vector_Down(): Vector;
	public function Vector_DistanceSquared(V1: Vector, V2: Vector): cpp.Float64;
	public function Vector_Distance2DSquared(V1: Vector, V2: Vector): cpp.Float64;
	public function Vector_Distance2D(V1: Vector, V2: Vector): cpp.Float64;
	public function Vector_Distance(V1: Vector, V2: Vector): cpp.Float64;
	public function Vector_CosineAngle2D(A: Vector, B: Vector): cpp.Float64;
	public function Vector_ComponentMin(A: Vector, B: Vector): Vector;
	public function Vector_ComponentMax(A: Vector, B: Vector): Vector;
	public function Vector_ClampSizeMax2D(A: Vector, Max: cpp.Float64): Vector;
	public function Vector_ClampSizeMax(A: Vector, Max: cpp.Float64): Vector;
	public function Vector_ClampSize2D(A: Vector, Min: cpp.Float64, Max: cpp.Float64): Vector;
	public function Vector_BoundedToCube(InVect: Vector, InRadius: cpp.Float32): Vector;
	...
	public function Vector4_SizeSquared3(A: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_SizeSquared(A: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_Size3(A: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_Size(A: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_Set(A: cpp.Reference<Vector4>, X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64, W: cpp.Float64): Void;
	public function Vector4_NormalUnsafe3(A: cpp.Reference<Vector4>): Vector4;
	public function Vector4_Normalize3(A: cpp.Reference<Vector4>, Tolerance: cpp.Float32): Void;
	public function Vector4_Normal3(A: cpp.Reference<Vector4>, Tolerance: cpp.Float32): Vector4;
	public function Vector4_Negated(A: cpp.Reference<Vector4>): Vector4;
	public function Vector4_MirrorByVector3(Direction: cpp.Reference<Vector4>, SurfaceNormal: cpp.Reference<Vector4>): Vector4;
	public function Vector4_IsZero(A: cpp.Reference<Vector4>): Bool;
	public function Vector4_IsUnit3(A: cpp.Reference<Vector4>, SquaredLenthTolerance: cpp.Float32): Bool;
	public function Vector4_IsNormal3(A: cpp.Reference<Vector4>): Bool;
	public function Vector4_IsNearlyZero3(A: cpp.Reference<Vector4>, Tolerance: cpp.Float32): Bool;
	public function Vector4_IsNAN(A: cpp.Reference<Vector4>): Bool;
	public function Vector4_DotProduct3(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_DotProduct(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): cpp.Float64;
	public function Vector4_CrossProduct3(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Vector4;
	public function Vector4_Assign(A: cpp.Reference<Vector4>, InVector: cpp.Reference<Vector4>): Void;
	public function Vector2DInterpTo_Constant(Current: Vector2D, Target: Vector2D, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Vector2D;
	public function Vector2DInterpTo(Current: Vector2D, Target: Vector2D, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Vector2D;
	public function Vector2D_Zero(): Vector2D;
	public function Vector2D_Unit45Deg(): Vector2D;
	public function Vector2D_One(): Vector2D;
	public function VEase(A: Vector, B: Vector, Alpha: cpp.Float32, EasingFunc: TEnumAsByte<EEasingFunc>, BlendExp: cpp.Float32, Steps: cpp.Int32): Vector;
	public function UtcNow(): DateTime;
	public function TransformVector4(Matrix: cpp.Reference<Matrix>, Vec4: cpp.Reference<Vector4>): Vector4;
	public function TransformRotation(T: cpp.Reference<Transform>, Rotation: Rotator): Rotator;
	public function TransformLocation(T: cpp.Reference<Transform>, Location: Vector): Vector;
	public function TransformDirection(T: cpp.Reference<Transform>, Direction: Vector): Vector;
	public function Transform_Determinant(Transform: cpp.Reference<Transform>): cpp.Float32;
	...
	public function TLerp(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>, Alpha: cpp.Float32, InterpMode: TEnumAsByte<ELerpInterpolationMode>): Transform;
	public function TInterpTo(Current: cpp.Reference<Transform>, Target: cpp.Reference<Transform>, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Transform;
	public function TimespanZeroValue(): Timespan;
	public function TimespanRatio(A: Timespan, B: Timespan): cpp.Float32;
	public function TimespanMinValue(): Timespan;
	public function TimespanMaxValue(): Timespan;
	public function TimespanFromString(TimespanString: FString, Result: cpp.Reference<Timespan>): Bool;
	public function TEase(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>, Alpha: cpp.Float32, EasingFunc: TEnumAsByte<EEasingFunc>, BlendExp: cpp.Float32, Steps: cpp.Int32): Transform;
	public function Tan(A: cpp.Float64): cpp.Float64;
	public function Subtract_VectorVector(A: Vector, B: Vector): Vector;
	public function Subtract_VectorInt(A: Vector, B: cpp.Int32): Vector;
	public function Subtract_VectorFloat(A: Vector, B: cpp.Float64): Vector;
	public function Subtract_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Vector4;
	public function Subtract_Vector2DVector2D(A: Vector2D, B: Vector2D): Vector2D;
	public function Subtract_Vector2DFloat(A: Vector2D, B: cpp.Float64): Vector2D;
	public function Subtract_TimespanTimespan(A: Timespan, B: Timespan): Timespan;
	public function Subtract_QuatQuat(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>): Quat;
	...
	public function Subtract_IntPointInt(A: IntPoint, B: cpp.Int32): IntPoint;
	...
	public function SelectTransform(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>, bPickA: Bool): Transform;
	...
	public function SelectObject(A: cpp.Star<Object>, B: cpp.Star<Object>, bSelectA: Bool): cpp.Star<Object>;
	...
	public function SelectClass(A: cpp.Star<Class>, B: cpp.Star<Class>, bSelectA: Bool): cpp.Star<Class>;
	...
	public function RotatorFromAxisAndAngle(Axis: Vector, Angle: cpp.Float32): Rotator;
	public function RotateAngleAxis(InVect: Vector, AngleDeg: cpp.Float32, Axis: Vector): Vector;
	public function RLerp(A: Rotator, B: Rotator, Alpha: cpp.Float32, bShortestPath: Bool): Rotator;
	public function RInterpTo_Constant(Current: Rotator, Target: Rotator, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Rotator;
	public function RInterpTo(Current: Rotator, Target: Rotator, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): Rotator;
	...
	public function REase(A: Rotator, B: Rotator, Alpha: cpp.Float32, bShortestPath: Bool, EasingFunc: TEnumAsByte<EEasingFunc>, BlendExp: cpp.Float32, Steps: cpp.Int32): Rotator;
	public function RandomUnitVectorInEllipticalConeInRadiansFromStream(Stream: cpp.Reference<RandomStream>, ConeDir: cpp.Reference<Vector>, MaxYawInRadians: cpp.Float32, MaxPitchInRadians: cpp.Float32): Vector;
	public function RandomUnitVectorInEllipticalConeInRadians(ConeDir: Vector, MaxYawInRadians: cpp.Float32, MaxPitchInRadians: cpp.Float32): Vector;
	public function RandomUnitVectorInEllipticalConeInDegreesFromStream(Stream: cpp.Reference<RandomStream>, ConeDir: cpp.Reference<Vector>, MaxYawInDegrees: cpp.Float32, MaxPitchInDegrees: cpp.Float32): Vector;
	public function RandomUnitVectorInEllipticalConeInDegrees(ConeDir: Vector, MaxYawInDegrees: cpp.Float32, MaxPitchInDegrees: cpp.Float32): Vector;
	public function RandomUnitVectorInConeInRadiansFromStream(Stream: cpp.Reference<RandomStream>, ConeDir: cpp.Reference<Vector>, ConeHalfAngleInRadians: cpp.Float32): Vector;
	public function RandomUnitVectorInConeInRadians(ConeDir: Vector, ConeHalfAngleInRadians: cpp.Float32): Vector;
	public function RandomUnitVectorInConeInDegreesFromStream(Stream: cpp.Reference<RandomStream>, ConeDir: cpp.Reference<Vector>, ConeHalfAngleInDegrees: cpp.Float32): Vector;
	public function RandomUnitVectorInConeInDegrees(ConeDir: Vector, ConeHalfAngleInDegrees: cpp.Float32): Vector;
	public function RandomUnitVectorFromStream(Stream: cpp.Reference<RandomStream>): Vector;
	public function RandomUnitVector(): Vector;
	public function RandomRotatorFromStream(Stream: cpp.Reference<RandomStream>, bRoll: Bool): Rotator;
	public function RandomRotator(bRoll: Bool): Rotator;
	public function RandomPointInBoundingBoxFromStream_Box(Stream: cpp.Reference<RandomStream>, Box: Box): Vector;
	public function RandomPointInBoundingBoxFromStream(Stream: cpp.Reference<RandomStream>, Center: Vector, HalfSize: Vector): Vector;
	...
	public function RandomIntegerInRangeFromStream(Stream: cpp.Reference<RandomStream>, Min: cpp.Int32, Max: cpp.Int32): cpp.Int32;
	public function RandomIntegerInRange(Min: cpp.Int32, Max: cpp.Int32): cpp.Int32;
	public function RandomIntegerFromStream(Stream: cpp.Reference<RandomStream>, Max: cpp.Int32): cpp.Int32;
	...
	public function RandomFloatInRangeFromStream(Stream: cpp.Reference<RandomStream>, Min: cpp.Float32, Max: cpp.Float32): cpp.Float32;
	public function RandomFloatInRange(Min: cpp.Float64, Max: cpp.Float64): cpp.Float64;
	public function RandomFloatFromStream(Stream: cpp.Reference<RandomStream>): cpp.Float32;
	public function RandomFloat(): cpp.Float64;
	public function RandomBoolWithWeightFromStream(RandomStream: cpp.Reference<RandomStream>, Weight: cpp.Float32): Bool;
	public function RandomBoolWithWeight(Weight: cpp.Float32): Bool;
	public function RandomBoolFromStream(Stream: cpp.Reference<RandomStream>): Bool;
	public function RandomBool(): Bool;
	public function RadiansToDegrees(A: cpp.Float64): cpp.Float64;
	public function QuaternionSpringInterp(Current: Quat, Target: Quat, SpringState: cpp.Reference<QuaternionSpringState>, Stiffness: cpp.Float32, CriticalDampingFactor: cpp.Float32, DeltaTime: cpp.Float32, Mass: cpp.Float32, TargetVelocityAmount: cpp.Float32, bInitializeFromTarget: Bool): Quat;
	public function Quat_VectorUp(Q: cpp.Reference<Quat>): Vector;
	public function Quat_VectorRight(Q: cpp.Reference<Quat>): Vector;
	public function Quat_VectorForward(Q: cpp.Reference<Quat>): Vector;
	public function Quat_UnrotateVector(Q: cpp.Reference<Quat>, V: cpp.Reference<Vector>): Vector;
	public function Quat_Slerp(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>, Alpha: cpp.Float64): Quat;
	public function Quat_SizeSquared(Q: cpp.Reference<Quat>): cpp.Float32;
	public function Quat_Size(Q: cpp.Reference<Quat>): cpp.Float32;
	...
	public function Quat_Rotator(Q: cpp.Reference<Quat>): Rotator;
	public function Quat_RotateVector(Q: cpp.Reference<Quat>, V: cpp.Reference<Vector>): Vector;
	public function Quat_Normalized(Q: cpp.Reference<Quat>, Tolerance: cpp.Float32): Quat;
	public function Quat_Normalize(Q: cpp.Reference<Quat>, Tolerance: cpp.Float32): Void;
	public function Quat_MakeFromEuler(Euler: cpp.Reference<Vector>): Quat;
	public function Quat_Log(Q: cpp.Reference<Quat>): Quat;
	public function Quat_IsNormalized(Q: cpp.Reference<Quat>): Bool;
	public function Quat_IsNonFinite(Q: cpp.Reference<Quat>): Bool;
	public function Quat_IsIdentity(Q: cpp.Reference<Quat>, Tolerance: cpp.Float32): Bool;
	public function Quat_IsFinite(Q: cpp.Reference<Quat>): Bool;
	public function Quat_Inversed(Q: cpp.Reference<Quat>): Quat;
	public function Quat_Identity(): Quat;
	public function Quat_GetRotationAxis(Q: cpp.Reference<Quat>): Vector;
	public function Quat_GetAxisZ(Q: cpp.Reference<Quat>): Vector;
	public function Quat_GetAxisY(Q: cpp.Reference<Quat>): Vector;
	public function Quat_GetAxisX(Q: cpp.Reference<Quat>): Vector;
	public function Quat_GetAngle(Q: cpp.Reference<Quat>): cpp.Float32;
	...
	public function Quat_Exp(Q: cpp.Reference<Quat>): Quat;
	public function Quat_Euler(Q: cpp.Reference<Quat>): Vector;
	public function Quat_EnforceShortestArcWith(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>): Void;
	public function Quat_AngularDistance(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>): cpp.Float32;
	...
	public function PointsAreCoplanar(Points: cpp.Reference<TArray<Vector>>, Tolerance: cpp.Float32): Bool;
	...
	public function Percent_Int64Int64(A: cpp.Int64, B: cpp.Int64): cpp.Int64;
	...
	public function NotEqualExactly_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Bool;
	public function NotEqualExactly_Vector2DVector2D(A: Vector2D, B: Vector2D): Bool;
	public function NotEqual_VectorVector(A: Vector, B: Vector, ErrorTolerance: cpp.Float32): Bool;
	public function NotEqual_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>, ErrorTolerance: cpp.Float32): Bool;
	public function NotEqual_Vector2DVector2D(A: Vector2D, B: Vector2D, ErrorTolerance: cpp.Float32): Bool;
	public function NotEqual_TimespanTimespan(A: Timespan, B: Timespan): Bool;
	public function NotEqual_RotatorRotator(A: Rotator, B: Rotator, ErrorTolerance: cpp.Float32): Bool;
	public function NotEqual_QuatQuat(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>, ErrorTolerance: cpp.Float32): Bool;
	public function NotEqual_ObjectObject(A: cpp.Star<Object>, B: cpp.Star<Object>): Bool;
	public function NotEqual_NameName(A: FName, B: FName): Bool;
	public function NotEqual_MatrixMatrix(A: cpp.Reference<Matrix>, B: cpp.Reference<Matrix>, Tolerance: cpp.Float32): Bool;
	...
	public function NotEqual_ClassClass(A: cpp.Star<Class>, B: cpp.Star<Class>): Bool;
	...
	public function NormalSafe2D(A: Vector2D, Tolerance: cpp.Float32): Vector2D;
	...
	public function Normal(A: Vector, Tolerance: cpp.Float32): Vector;
	public function NegateVector(A: Vector): Vector;
	public function NegateRotator(A: Rotator): Rotator;
	public function Negated2D(A: cpp.Reference<Vector2D>): Vector2D;
	public function NearlyEqual_TransformTransform(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>, LocationTolerance: cpp.Float32, RotationTolerance: cpp.Float32, Scale3DTolerance: cpp.Float32): Bool;
	...
	public function Multiply_VectorInt(A: Vector, B: cpp.Int32): Vector;
	public function Multiply_VectorFloat(A: Vector, B: cpp.Float64): Vector;
	public function Multiply_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Vector4;
	public function Multiply_Vector2DVector2D(A: Vector2D, B: Vector2D): Vector2D;
	public function Multiply_Vector2DFloat(A: Vector2D, B: cpp.Float64): Vector2D;
	public function Multiply_TimespanFloat(A: Timespan, Scalar: cpp.Float32): Timespan;
	public function Multiply_RotatorInt(A: Rotator, B: cpp.Int32): Rotator;
	public function Multiply_RotatorFloat(A: Rotator, B: cpp.Float32): Rotator;
	public function Multiply_QuatQuat(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>): Quat;
	public function Multiply_MatrixMatrix(A: cpp.Reference<Matrix>, B: cpp.Reference<Matrix>): Matrix;
	public function Multiply_MatrixFloat(A: cpp.Reference<Matrix>, B: cpp.Float64): Matrix;
	public function Multiply_LinearColorLinearColor(A: LinearColor, B: LinearColor): LinearColor;
	public function Multiply_LinearColorFloat(A: LinearColor, B: cpp.Float32): LinearColor;
	public function Multiply_IntPointIntPoint(A: IntPoint, B: IntPoint): IntPoint;
	public function Multiply_IntPointInt(A: IntPoint, B: cpp.Int32): IntPoint;
	...
	public function MedianOfIntArray(IntArray: TArray<cpp.Int32>, MedianValue: cpp.Reference<cpp.Float32>): Void;
	...
	public function Matrix_TransformVector4(M: cpp.Reference<Matrix>, V: Vector4): Vector4;
	public function Matrix_TransformVector(M: cpp.Reference<Matrix>, V: Vector): Vector4;
	public function Matrix_TransformPosition(M: cpp.Reference<Matrix>, V: Vector): Vector4;
	public function Matrix_ToQuat(M: cpp.Reference<Matrix>): Quat;
	public function Matrix_SetOrigin(M: cpp.Reference<Matrix>, NewOrigin: Vector): Void;
	public function Matrix_SetColumn(M: cpp.Reference<Matrix>, Column: TEnumAsByte<EMatrixColumns>, Value: Vector): Void;
	public function Matrix_SetAxis(M: cpp.Reference<Matrix>, Axis: TEnumAsByte<EAxis>, AxisVector: Vector): Void;
	public function Matrix_ScaleTranslation(M: cpp.Reference<Matrix>, Scale3D: Vector): Matrix;
	public function Matrix_RemoveTranslation(M: cpp.Reference<Matrix>): Matrix;
	public function Matrix_RemoveScaling(M: cpp.Reference<Matrix>, Tolerance: cpp.Float32): Void;
	public function Matrix_Mirror(M: cpp.Reference<Matrix>, MirrorAxis: TEnumAsByte<EAxis>, FlipAxis: TEnumAsByte<EAxis>): Matrix;
	public function Matrix_InverseTransformVector(M: cpp.Reference<Matrix>, V: Vector): Vector;
	public function Matrix_InverseTransformPosition(M: cpp.Reference<Matrix>, V: Vector): Vector;
	public function Matrix_Identity(): Matrix;
	public function Matrix_GetUnitAxis(M: cpp.Reference<Matrix>, Axis: TEnumAsByte<EAxis>): Vector;
	...
	public function Matrix_GetTransposed(M: cpp.Reference<Matrix>): Matrix;
	public function Matrix_GetTransposeAdjoint(M: cpp.Reference<Matrix>): Matrix;
	public function Matrix_GetScaleVector(M: cpp.Reference<Matrix>, Tolerance: cpp.Float32): Vector;
	public function Matrix_GetScaledAxis(M: cpp.Reference<Matrix>, Axis: TEnumAsByte<EAxis>): Vector;
	...
	public function Matrix_GetRotDeterminant(M: cpp.Reference<Matrix>): cpp.Float32;
	public function Matrix_GetRotator(M: cpp.Reference<Matrix>): Rotator;
	public function Matrix_GetOrigin(InMatrix: cpp.Reference<Matrix>): Vector;
	public function Matrix_GetMaximumAxisScale(M: cpp.Reference<Matrix>): cpp.Float32;
	public function Matrix_GetMatrixWithoutScale(M: cpp.Reference<Matrix>, Tolerance: cpp.Float32): Matrix;
	public function Matrix_GetInverse(M: cpp.Reference<Matrix>): Matrix;
	public function Matrix_GetFrustumTopPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetFrustumRightPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetFrustumNearPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetFrustumLeftPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetFrustumFarPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetFrustumBottomPlane(M: cpp.Reference<Matrix>, OutPlane: cpp.Reference<Plane>): Bool;
	public function Matrix_GetDeterminant(M: cpp.Reference<Matrix>): cpp.Float32;
	public function Matrix_GetColumn(M: cpp.Reference<Matrix>, Column: TEnumAsByte<EMatrixColumns>): Vector;
	public function Matrix_ContainsNaN(M: cpp.Reference<Matrix>): Bool;
	public function Matrix_ConcatenateTranslation(M: cpp.Reference<Matrix>, Translation: Vector): Matrix;
	public function Matrix_ApplyScale(M: cpp.Reference<Matrix>, Scale: cpp.Float32): Matrix;
	...
	public function MakeVector_NetQuantizeNormal(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64): Vector_NetQuantizeNormal;
	public function MakeVector_NetQuantize100(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64): Vector_NetQuantize100;
	public function MakeVector_NetQuantize10(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64): Vector_NetQuantize10;
	public function MakeVector_NetQuantize(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64): Vector_NetQuantize;
	public function MakeVector4(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64, W: cpp.Float64): Vector4;
	public function MakeVector2D(X: cpp.Float64, Y: cpp.Float64): Vector2D;
	public function MakeVector(X: cpp.Float64, Y: cpp.Float64, Z: cpp.Float64): Vector;
	public function MakeTransform(Location: Vector, Rotation: Rotator, Scale: Vector): Transform;
	public function MakeTimespan2(Days: cpp.Int32, Hours: cpp.Int32, Minutes: cpp.Int32, Seconds: cpp.Int32, FractionNano: cpp.Int32): Timespan;
	public function MakeTimespan(Days: cpp.Int32, Hours: cpp.Int32, Minutes: cpp.Int32, Seconds: cpp.Int32, Milliseconds: cpp.Int32): Timespan;
	public function MakeRotFromZY(Z: cpp.Reference<Vector>, Y: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromZX(Z: cpp.Reference<Vector>, X: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromZ(Z: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromYZ(Y: cpp.Reference<Vector>, Z: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromYX(Y: cpp.Reference<Vector>, X: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromY(Y: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromXZ(X: cpp.Reference<Vector>, Z: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromXY(X: cpp.Reference<Vector>, Y: cpp.Reference<Vector>): Rotator;
	public function MakeRotFromX(X: cpp.Reference<Vector>): Rotator;
	public function MakeRotator(Roll: cpp.Float32, Pitch: cpp.Float32, Yaw: cpp.Float32): Rotator;
	public function MakeRotationFromAxes(Forward: Vector, Right: Vector, Up: Vector): Rotator;
	public function MakeRelativeTransform(A: cpp.Reference<Transform>, RelativeTo: cpp.Reference<Transform>): Transform;
	public function MakeRandomStream(InitialSeed: cpp.Int32): RandomStream;
	public function MakeQuat(X: cpp.Float32, Y: cpp.Float32, Z: cpp.Float32, W: cpp.Float32): Quat;
	public function MakeQualifiedFrameTime(Frame: FrameNumber, FrameRate: FrameRate, SubFrame: cpp.Float32): QualifiedFrameTime;
	...
	public function MakeFrameRate(Numerator: cpp.Int32, Denominator: cpp.Int32): FrameRate;
	public function MakeDateTime(Year: cpp.Int32, Month: cpp.Int32, Day: cpp.Int32, Hour: cpp.Int32, Minute: cpp.Int32, Second: cpp.Int32, Millisecond: cpp.Int32): DateTime;
	public function MakeColor(R: cpp.Float32, G: cpp.Float32, B: cpp.Float32, A: cpp.Float32): LinearColor;
	public function MakeBoxSphereBounds(Origin: Vector, BoxExtent: Vector, SphereRadius: cpp.Float32): BoxSphereBounds;
	...
	public function LinePlaneIntersection_OriginNormal(LineStart: cpp.Reference<Vector>, LineEnd: cpp.Reference<Vector>, PlaneOrigin: Vector, PlaneNormal: Vector, T: cpp.Reference<cpp.Float32>, Intersection: cpp.Reference<Vector>): Bool;
	public function LinePlaneIntersection(LineStart: cpp.Reference<Vector>, LineEnd: cpp.Reference<Vector>, APlane: cpp.Reference<Plane>, T: cpp.Reference<cpp.Float32>, Intersection: cpp.Reference<Vector>): Bool;
	public function LinearColorLerpUsingHSV(A: LinearColor, B: LinearColor, Alpha: cpp.Float32): LinearColor;
	public function LinearColorLerp(A: LinearColor, B: LinearColor, Alpha: cpp.Float32): LinearColor;
	...
	public function LinearColor_ToNewOpacity(InColor: LinearColor, InOpacity: cpp.Float32): LinearColor;
	...
	public function LinearColor_IsNearEqual(A: LinearColor, B: LinearColor, Tolerance: cpp.Float32): Bool;
	public function LinearColor_Green(): LinearColor;
	public function LinearColor_Gray(): LinearColor;
	public function LinearColor_GetMin(InColor: LinearColor): cpp.Float32;
	public function LinearColor_GetMax(InColor: LinearColor): cpp.Float32;
	public function LinearColor_GetLuminance(InColor: LinearColor): cpp.Float32;
	public function LinearColor_Distance(C1: LinearColor, C2: LinearColor): cpp.Float32;
	public function LinearColor_Desaturated(InColor: LinearColor, InDesaturation: cpp.Float32): LinearColor;
	...
	public function IsZero2D(A: cpp.Reference<Vector2D>): Bool;
	public function IsPointInBoxWithTransform_Box(Point: Vector, BoxWorldTransform: cpp.Reference<Transform>, BoxExtent: Box): Bool;
	public function IsPointInBoxWithTransform(Point: Vector, BoxWorldTransform: cpp.Reference<Transform>, BoxExtent: Vector): Bool;
	...
	public function IsNearlyZero2D(A: cpp.Reference<Vector2D>, Tolerance: cpp.Float32): Bool;
	...
	public function InvertTransform(T: cpp.Reference<Transform>): Transform;
	public function InverseTransformRotation(T: cpp.Reference<Transform>, Rotation: Rotator): Rotator;
	public function InverseTransformLocation(T: cpp.Reference<Transform>, Location: Vector): Vector;
	public function InverseTransformDirection(T: cpp.Reference<Transform>, Direction: Vector): Vector;
	...
	public function HSVToRGB(H: cpp.Float32, S: cpp.Float32, V: cpp.Float32, A: cpp.Float32): LinearColor;
	...
	public function GetYear(A: DateTime): cpp.Int32;
	public function GetYawPitchFromVector(InVec: Vector, Yaw: cpp.Reference<cpp.Float32>, Pitch: cpp.Reference<cpp.Float32>): Void;
	public function GetVectorArrayAverage(Vectors: cpp.Reference<TArray<Vector>>): Vector;
	public function GetUpVector(InRot: Rotator): Vector;
	public function GetTotalSeconds(A: Timespan): cpp.Float32;
	public function GetTotalMinutes(A: Timespan): cpp.Float32;
	public function GetTotalMilliseconds(A: Timespan): cpp.Float32;
	public function GetTotalHours(A: Timespan): cpp.Float32;
	public function GetTotalDays(A: Timespan): cpp.Float32;
	...
	public function GetSeconds(A: Timespan): cpp.Int32;
	public function GetSecond(A: DateTime): cpp.Int32;
	public function GetRotated2D(A: Vector2D, AngleDeg: cpp.Float32): Vector2D;
	...
	public function GetPointDistanceToSegment(Point: Vector, SegmentStart: Vector, SegmentEnd: Vector): cpp.Float32;
	public function GetPointDistanceToLine(Point: Vector, LineOrigin: Vector, LineDirection: Vector): cpp.Float32;
	public function GetPI(): cpp.Float64;
	public function GetMonth(A: DateTime): cpp.Int32;
	public function GetMinutes(A: Timespan): cpp.Int32;
	public function GetMinute(A: DateTime): cpp.Int32;
	public function GetMinElement(A: Vector): cpp.Float64;
	public function GetMin2D(A: Vector2D): cpp.Float64;
	public function GetMilliseconds(A: Timespan): cpp.Int32;
	public function GetMillisecond(A: DateTime): cpp.Int32;
	public function GetMaxElement(A: Vector): cpp.Float64;
	public function GetMax2D(A: Vector2D): cpp.Float64;
	public function GetHours(A: Timespan): cpp.Int32;
	public function GetHour12(A: DateTime): cpp.Int32;
	public function GetHour(A: DateTime): cpp.Int32;
	...
	public function GetDays(A: Timespan): cpp.Int32;
	public function GetDayOfYear(A: DateTime): cpp.Int32;
	public function GetDay(A: DateTime): cpp.Int32;
	...
	public function GetAbsMax2D(A: Vector2D): cpp.Float64;
	...
	public function FTruncVector(InVector: cpp.Reference<Vector>): IntVector;
	public function FTrunc64(A: cpp.Float64): cpp.Int64;
	public function FTrunc(A: cpp.Float64): cpp.Int32;
	public function FromSeconds(Seconds: cpp.Float32): Timespan;
	public function FromMinutes(Minutes: cpp.Float32): Timespan;
	public function FromMilliseconds(Milliseconds: cpp.Float32): Timespan;
	public function FromHours(Hours: cpp.Float32): Timespan;
	public function FromDays(Days: cpp.Float32): Timespan;
	...
	public function FindRelativeLookAtRotation(StartTransform: cpp.Reference<Transform>, TargetLocation: cpp.Reference<Vector>): Rotator;
	...
	public function FindLookAtRotation(Start: cpp.Reference<Vector>, Target: cpp.Reference<Vector>): Rotator;
	...
	public function EqualExactly_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Bool;
	public function EqualExactly_Vector2DVector2D(A: Vector2D, B: Vector2D): Bool;
	public function EqualEqual_VectorVector(A: Vector, B: Vector, ErrorTolerance: cpp.Float32): Bool;
	public function EqualEqual_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>, ErrorTolerance: cpp.Float32): Bool;
	public function EqualEqual_Vector2DVector2D(A: Vector2D, B: Vector2D, ErrorTolerance: cpp.Float32): Bool;
	public function EqualEqual_TransformTransform(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>): Bool;
	public function EqualEqual_TimespanTimespan(A: Timespan, B: Timespan): Bool;
	public function EqualEqual_RotatorRotator(A: Rotator, B: Rotator, ErrorTolerance: cpp.Float32): Bool;
	public function EqualEqual_QuatQuat(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>, Tolerance: cpp.Float32): Bool;
	public function EqualEqual_ObjectObject(A: cpp.Star<Object>, B: cpp.Star<Object>): Bool;
	public function EqualEqual_NameName(A: FName, B: FName): Bool;
	public function EqualEqual_MatrixMatrix(A: cpp.Reference<Matrix>, B: cpp.Reference<Matrix>, Tolerance: cpp.Float32): Bool;
	...
	public function EqualEqual_ClassClass(A: cpp.Star<Class>, B: cpp.Star<Class>): Bool;
	...
	public function Ease(A: cpp.Float64, B: cpp.Float64, Alpha: cpp.Float64, EasingFunc: TEnumAsByte<EEasingFunc>, BlendExp: cpp.Float64, Steps: cpp.Int32): cpp.Float64;
	public function DynamicWeightedMovingAverage_FVector(CurrentSample: Vector, PreviousSample: Vector, MaxDistance: cpp.Float32, MinWeight: cpp.Float32, MaxWeight: cpp.Float32): Vector;
	public function DynamicWeightedMovingAverage_FRotator(CurrentSample: Rotator, PreviousSample: Rotator, MaxDistance: cpp.Float32, MinWeight: cpp.Float32, MaxWeight: cpp.Float32): Rotator;
	...
	public function DotProduct2D(A: Vector2D, B: Vector2D): cpp.Float64;
	public function Dot_VectorVector(A: Vector, B: Vector): cpp.Float64;
	public function Divide_VectorVector(A: Vector, B: Vector): Vector;
	public function Divide_VectorInt(A: Vector, B: cpp.Int32): Vector;
	public function Divide_VectorFloat(A: Vector, B: cpp.Float64): Vector;
	public function Divide_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Vector4;
	public function Divide_Vector2DVector2D(A: Vector2D, B: Vector2D): Vector2D;
	public function Divide_Vector2DFloat(A: Vector2D, B: cpp.Float64): Vector2D;
	public function Divide_TimespanFloat(A: Timespan, Scalar: cpp.Float32): Timespan;
	...
	public function Divide_IntPointInt(A: IntPoint, B: cpp.Int32): IntPoint;
	...
	public function DistanceSquared2D(V1: Vector2D, V2: Vector2D): cpp.Float64;
	public function Distance2D(V1: Vector2D, V2: Vector2D): cpp.Float64;
	...
	public function DateTimeFromString(DateTimeString: FString, Result: cpp.Reference<DateTime>): Bool;
	public function DateTimeFromIsoString(IsoString: FString, Result: cpp.Reference<DateTime>): Bool;
	public function CrossProduct2D(A: Vector2D, B: Vector2D): cpp.Float64;
	public function Cross_VectorVector(A: Vector, B: Vector): Vector;
	public function CreateVectorFromYawPitch(Yaw: cpp.Float32, Pitch: cpp.Float32, Length: cpp.Float32): Vector;
	...
	public function Conv_Vector4ToVector(InVector4: cpp.Reference<Vector4>): Vector;
	public function Conv_Vector4ToRotator(InVec: cpp.Reference<Vector4>): Rotator;
	public function Conv_Vector4ToQuaternion(InVec: cpp.Reference<Vector4>): Quat;
	public function Conv_Vector2DToVector(InVector2D: Vector2D, Z: cpp.Float32): Vector;
	public function Conv_Vector2DToIntPoint(InVector2D: Vector2D): IntPoint;
	public function Conv_TransformToMatrix(Transform: cpp.Reference<Transform>): Matrix;
	public function Conv_RotatorToVector(InRot: Rotator): Vector;
	public function Conv_RotatorToTransform(InRotator: cpp.Reference<Rotator>): Transform;
	public function Conv_RotatorToQuaternion(InRot: Rotator): Quat;
	public function Conv_MatrixToTransform(InMatrix: cpp.Reference<Matrix>): Transform;
	public function Conv_MatrixToRotator(InMatrix: cpp.Reference<Matrix>): Rotator;
	...
	public function Conv_IntVectorToVector(InIntVector: cpp.Reference<IntVector>): Vector;
	public function Conv_IntToVector(InInt: cpp.Int32): Vector;
	public function Conv_IntToIntVector(InInt: cpp.Int32): IntVector;
	...
	public function Conv_DoubleToVector2D(InDouble: cpp.Float64): Vector2D;
	public function Conv_DoubleToVector(InDouble: cpp.Float64): Vector;
	public function Conv_DoubleToLinearColor(InDouble: cpp.Float64): LinearColor;
	...
	public function Conv_BoolToDouble(InBool: Bool): cpp.Float64;
	public function Conv_BoolToByte(InBool: Bool): cpp.UInt8;
	public function ComposeTransforms(A: cpp.Reference<Transform>, B: cpp.Reference<Transform>): Transform;
	...
	public function ClampVectorSize(A: Vector, Min: cpp.Float64, Max: cpp.Float64): Vector;
	...
	public function ClampAxes2D(A: Vector2D, MinAxisVal: cpp.Float64, MaxAxisVal: cpp.Float64): Vector2D;
	...
	public function CInterpTo(Current: LinearColor, Target: LinearColor, DeltaTime: cpp.Float32, InterpSpeed: cpp.Float32): LinearColor;
	...
	public function AverageOfIntArray(IntArray: cpp.Reference<TArray<cpp.Int32>>, AverageValue: cpp.Reference<cpp.Float32>): Void;
	...
	public function Add_VectorInt(A: Vector, B: cpp.Int32): Vector;
	public function Add_VectorFloat(A: Vector, B: cpp.Float64): Vector;
	public function Add_Vector4Vector4(A: cpp.Reference<Vector4>, B: cpp.Reference<Vector4>): Vector4;
	public function Add_Vector2DVector2D(A: Vector2D, B: Vector2D): Vector2D;
	public function Add_Vector2DFloat(A: Vector2D, B: cpp.Float64): Vector2D;
	public function Add_TimespanTimespan(A: Timespan, B: Timespan): Timespan;
	public function Add_QuatQuat(A: cpp.Reference<Quat>, B: cpp.Reference<Quat>): Quat;
	public function Add_MatrixMatrix(A: cpp.Reference<Matrix>, B: cpp.Reference<Matrix>): Matrix;
	...
	public function Add_IntPointInt(A: IntPoint, B: cpp.Int32): IntPoint;
...
abstract KismetMathLibraryPtr(cpp.Star<KismetMathLibrary>) from cpp.Star<KismetMathLibrary> to cpp.Star<KismetMathLibrary>{
	@:from
