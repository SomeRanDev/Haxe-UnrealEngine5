...
extern class PlayerController extends Controller {
	...
	private var AsyncPhysicsDataComponent: cpp.Star<AsyncPhysicsInputComp>;
	...
	public function GetStreamingSourceShapes(OutShapes: cpp.Reference<TArray<StreamingSourceShape>>): Void;
	public function GetStreamingSourcePriority(): EStreamingSourcePriority;
	public function GetStreamingSourceLocationAndRotation(OutLocation: cpp.Reference<Vector>, OutRotation: cpp.Reference<Rotator>): Void;
	...
	@:protected public function GetAsyncPhysicsDataToWrite(): cpp.Star<AsyncPhysicsData>;
	@:protected public function GetAsyncPhysicsDataToConsume(): cpp.Star<AsyncPhysicsData.ConstAsyncPhysicsData>;
	...
	public function ClientUpdateLevelStreamingStatus(PackageName: FName, bNewShouldBeLoaded: Bool, bNewShouldBeVisible: Bool, bNewShouldBlockOnLoad: Bool, LODIndex: cpp.Int32, TransactionId: NetLevelVisibilityTransactionId, bNewShouldBlockOnUnload: Bool): Void;
	...
	private function ClientAckTimeDilation(TimeDilation: cpp.Float32, ServerStep: cpp.Int32): Void;
