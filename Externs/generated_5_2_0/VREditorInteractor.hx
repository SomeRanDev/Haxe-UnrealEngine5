...
extern class VREditorInteractor extends ViewportInteractor {
	...
	@:protected public var LaserMotionControllerComponent: cpp.Star<MotionControllerComp>;
	...
	public function ReplaceHandMeshComponent(NewMesh: cpp.Star<StaticMesh>, MeshScale: Vector): Void;
