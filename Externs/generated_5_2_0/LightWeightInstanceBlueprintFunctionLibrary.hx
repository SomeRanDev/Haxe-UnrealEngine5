...
extern class LightWeightInstanceBlueprintFunctionLibrary extends BlueprintFunctionLibrary {
	public function CreateNewLightWeightInstance(ActorClass: cpp.Star<Class>, Transform: Transform, Layer: cpp.Star<DataLayerInstance>, World: cpp.Star<World>): ActorInstanceHandle;
