...
abstract AssetDefinition_NiagaraEmitterPtr(ucpp.Ptr<AssetDefinition_NiagaraEmitter>) from ucpp.Ptr<AssetDefinition_NiagaraEmitter> to ucpp.Ptr<AssetDefinition_NiagaraEmitter>{
	@:from
