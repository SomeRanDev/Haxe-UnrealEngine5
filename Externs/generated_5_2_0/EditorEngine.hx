...
extern class EditorEngine extends Engine {
	...
	private var EditorWorldExtensionsManager: cpp.Star<EditorWorldExtensionManager>;
	private var DragDropHandler: cpp.Star<LevelEditorDragDropHandler>;
	@:protected public var ActorGroupingUtilsClassName: SoftClassPath;
	@:protected public var ActorGroupingUtils: cpp.Star<ActorGroupingUtils>;
