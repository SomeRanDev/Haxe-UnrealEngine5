...
extern class DataLayerSubsystem extends WorldSubsystem {
	public var OnDataLayerRuntimeStateChanged: HaxeMulticastSparseDelegateProperty<(cpp.Star<DataLayerInstance.ConstDataLayerInstance>, EDataLayerRuntimeState) -> Void>;
	private var DataLayerLoadingPolicyClass: TSoftClassPtr<Class>;
	private var DataLayerLoadingPolicy: cpp.Star<DataLayerLoadingPolicy>;
	...
	public function SetDataLayerInstanceRuntimeState(InDataLayerAsset: cpp.Star<DataLayerAsset.ConstDataLayerAsset>, InState: EDataLayerRuntimeState, bInIsRecursive: Bool): Void;
	...
	public function GetDataLayerInstanceRuntimeState(InDataLayerAsset: cpp.Star<DataLayerAsset.ConstDataLayerAsset>): EDataLayerRuntimeState;
	public function GetDataLayerInstanceFromAsset(InDataLayerAsset: cpp.Star<DataLayerAsset.ConstDataLayerAsset>): cpp.Star<DataLayerInstance>;
	public function GetDataLayerInstanceEffectiveRuntimeState(InDataLayerAsset: cpp.Star<DataLayerAsset.ConstDataLayerAsset>): EDataLayerRuntimeState;
	public function GetDataLayerFromName(InDataLayerName: FName): cpp.Star<DataLayerInstance>;
	public function GetDataLayerFromLabel(InDataLayerLabel: FName): cpp.Star<DataLayerInstance>;
	...
	public function GetDataLayer(InDataLayer: cpp.Reference<ActorDataLayer>): cpp.Star<DataLayerInstance>;
...
abstract ConstDataLayerSubsystem(DataLayerSubsystem) from DataLayerSubsystem {
	public extern var OnDataLayerRuntimeStateChanged(get, never): HaxeMulticastSparseDelegateProperty<(cpp.Star<DataLayerInstance.ConstDataLayerInstance>, EDataLayerRuntimeState) -> Void>;
	public inline extern function get_OnDataLayerRuntimeStateChanged(): HaxeMulticastSparseDelegateProperty<(cpp.Star<DataLayerInstance.ConstDataLayerInstance>, EDataLayerRuntimeState) -> Void> return this.OnDataLayerRuntimeStateChanged;
}
