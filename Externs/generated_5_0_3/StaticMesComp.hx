...
extern class StaticMesComp extends MeshCompoComp {
	...
	public function GetLocalBounds(Min: cpp.Reference<FVector>, Max: cpp.Reference<FVector>): Void;
}

@:forward(GetLocalBounds)
abstract ConstStaticMesComp(StaticMesComp) from StaticMesComp {
}