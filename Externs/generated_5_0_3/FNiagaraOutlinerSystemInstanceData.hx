...
extern class FNiagaraOutlinerSystemInstanceData {
	public var ComponentName: FString;
	public var Emitters: TArray<FNiagaraOutlinerEmitterInstanceData>;
	public var ActualExecutionState: ENiagaraExecutionState;
	public var RequestedExecutionState: ENiagaraExecutionState;
	public var ScalabilityState: FNiagaraScalabilityState;
	public var bPendingKill: Bool;
	public var bUsingCullProxy: Bool;
	public var PoolMethod: ENCPoolMethod;
	public var AverageTime: FNiagaraOutlinerTimingData;
	public var MaxTime: FNiagaraOutlinerTimingData;
