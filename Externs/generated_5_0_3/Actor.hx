...
extern class Actor extends Object {
	...
	public overload function SetActorRotation(@:const NewRotation: cpp.Reference<Quat>): Bool;
	public overload function SetActorRotation(@:const NewRotation: cpp.Reference<Quat>, Teleport: ETeleportType): Bool;
	...
	public overload function SetActorLocationAndRotation(NewLocation: Vector, @:const NewRotation: cpp.Reference<Quat>): Bool;
	public overload function SetActorLocationAndRotation(NewLocation: Vector, @:const NewRotation: cpp.Reference<Quat>, bSweep: Bool): Bool;
	public overload function SetActorLocationAndRotation(NewLocation: Vector, @:const NewRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>): Bool;
	...
	public overload function AddActorWorldRotation(DeltaRotation: cpp.Reference<Quat>): Void;
	public overload function AddActorWorldRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool): Void;
	public overload function AddActorWorldRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>): Void;
	public overload function AddActorWorldRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>, Teleport: ETeleportType): Void;
	...
	public overload function AddActorLocalRotation(DeltaRotation: cpp.Reference<Quat>): Void;
	public overload function AddActorLocalRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool): Void;
	public overload function AddActorLocalRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>): Void;
	public overload function AddActorLocalRotation(DeltaRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>, Teleport: ETeleportType): Void;
	...
	public overload function SetActorRelativeRotation(NewRelativeRotation: cpp.Reference<Quat>): Void;
	public overload function SetActorRelativeRotation(NewRelativeRotation: cpp.Reference<Quat>, bSweep: Bool): Void;
	public overload function SetActorRelativeRotation(NewRelativeRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>): Void;
	public overload function SetActorRelativeRotation(NewRelativeRotation: cpp.Reference<Quat>, bSweep: Bool, OutSweepHitResult: cpp.Star<HitResult>, Teleport: ETeleportType): Void;
