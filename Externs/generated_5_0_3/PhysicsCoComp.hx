...
extern class PhysicsCoComp extends SceneCompComp {
	...
	public function SetLinearVelocityTarget(InVelTarget: cpp.Reference<FVector>): Void;
	public function SetLinearVelocityDrive(bEnableDriveX: Bool, bEnableDriveY: Bool, bEnableDriveZ: Bool): Void;
	public function SetLinearPositionTarget(InPosTarget: cpp.Reference<FVector>): Void;
	...
	public function SetConstraintReferencePosition(Frame: EConstraintFrame, RefPosition: cpp.Reference<FVector>): Void;
	public function SetConstraintReferenceOrientation(Frame: EConstraintFrame, PriAxis: cpp.Reference<FVector>, SecAxis: cpp.Reference<FVector>): Void;
	public function SetConstraintReferenceFrame(Frame: EConstraintFrame, RefFrame: cpp.Reference<FTransform>): Void;
	...
	public function SetAngularVelocityTarget(InVelTarget: cpp.Reference<FVector>): Void;
	...
	public function SetAngularOrientationTarget(InPosTarget: cpp.Reference<FRotator>): Void;
	...
	public function GetConstraintForce(OutLinearForce: cpp.Reference<FVector>, OutAngularForce: cpp.Reference<FVector>): Void;
	public function GetConstraint(): cpp.Reference<FConstraintInstanceAccessor>;
...
abstract ConstPhysicsCoComp(PhysicsCoComp) from PhysicsCoComp {
}