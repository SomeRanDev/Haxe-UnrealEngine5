...
extern class ModularSynthComp extends SynthComp {
	...
	public function SetSynthPreset(SynthPreset: cpp.Reference<ModularSynthPreset>): Void;
...
abstract ConstModularSynthComp(ModularSynthComp) from ModularSynthComp {
	public extern var VoiceCount(get, never): cpp.Int32;
	public inline extern function get_VoiceCount(): cpp.Int32 return this.VoiceCount;
}

@:forward
@:nativeGen
@:native("ModularSynthComp*")
abstract ModularSynthCompPtr(cpp.Star<ModularSynthComp>) from cpp.Star<ModularSynthComp> to cpp.Star<ModularSynthComp>{
	@:from
