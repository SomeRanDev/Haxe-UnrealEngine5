...
extern class KismetArrayLibrary extends BlueprintFunctionLibrary {
	...
	public function Array_RemoveItem(TargetArray: cpp.Reference<TArray<cpp.Int32>>, Item: cpp.Reference<cpp.Int32>): Bool;
	...
	public function Array_Length(TargetArray: cpp.Reference<TArray<cpp.Int32>>): cpp.Int32;
	public function Array_LastIndex(TargetArray: cpp.Reference<TArray<cpp.Int32>>): cpp.Int32;
	public function Array_IsValidIndex(TargetArray: cpp.Reference<TArray<cpp.Int32>>, IndexToTest: cpp.Int32): Bool;
	public function Array_IsNotEmpty(TargetArray: cpp.Reference<TArray<cpp.Int32>>): Bool;
	public function Array_IsEmpty(TargetArray: cpp.Reference<TArray<cpp.Int32>>): Bool;
	...
	public function Array_Identical(ArrayA: cpp.Reference<TArray<cpp.Int32>>, ArrayB: cpp.Reference<TArray<cpp.Int32>>): Bool;
	public function Array_Get(TargetArray: cpp.Reference<TArray<cpp.Int32>>, Index: cpp.Int32, Item: cpp.Reference<cpp.Int32>): Void;
	public function Array_Find(TargetArray: cpp.Reference<TArray<cpp.Int32>>, ItemToFind: cpp.Reference<cpp.Int32>): cpp.Int32;
	public function Array_Contains(TargetArray: cpp.Reference<TArray<cpp.Int32>>, ItemToFind: cpp.Reference<cpp.Int32>): Bool;
	...
	public function Array_AddUnique(TargetArray: cpp.Reference<TArray<cpp.Int32>>, NewItem: cpp.Reference<cpp.Int32>): cpp.Int32;
	public function Array_Add(TargetArray: cpp.Reference<TArray<cpp.Int32>>, NewItem: cpp.Reference<cpp.Int32>): cpp.Int32;
