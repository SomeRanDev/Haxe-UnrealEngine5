...
extern class StaticMeshEditorSubsystem extends EditorSubsystem {
	...
	public function SetLODGroup(StaticMesh: cpp.Star<StaticMesh>, LODGroup: FName, bRebuildImmediately: Bool): cpp.Reference<Bool>;
	...
	public function GetNaniteSettings(StaticMesh: cpp.Star<StaticMesh>): cpp.Reference<MeshNaniteSettings>;
	...
	public function GetLODMaterialSlot(StaticMesh: cpp.Star<StaticMesh>, LODIndex: cpp.Int32, SectionIndex: cpp.Int32): cpp.Reference<cpp.Int32>;
	public function GetLODGroup(StaticMesh: cpp.Star<StaticMesh>): cpp.Reference<FName>;
