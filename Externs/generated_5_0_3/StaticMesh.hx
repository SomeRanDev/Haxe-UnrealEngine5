...
@:forward(
	GetNumSections, GetNumLODs, GetMinimumLODForQualityLevels, GetMinimumLODForQualityLevel, GetMinimumLODForPlatforms,
	GetMinimumLODForPlatform, GetMaterialIndex, GetMaterial, GetBounds, GetBoundingBox,
	FindSocket
)
@:nativeGen
