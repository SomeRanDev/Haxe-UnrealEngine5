...
@:nativeGen
@:native("GroomAsset*")
abstract GroomAssetPtr(cpp.Star<GroomAsset>) from cpp.Star<GroomAsset> to cpp.Star<GroomAsset>{
	@:from
	public static extern inline function fromValue(v: GroomAsset): GroomAssetPtr {
		return untyped __cpp__("&({0})", v);
	}

	@:to
	public extern inline function asValue(): GroomAsset {
