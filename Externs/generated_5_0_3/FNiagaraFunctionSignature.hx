...
extern class FNiagaraFunctionSignature {
	public var Name: FName;
	public var Inputs: TArray<FNiagaraVariable>;
	...
	public var InputDescriptions: TMap<FNiagaraVariableBase, FText>;
	public var OutputDescriptions: TMap<FNiagaraVariableBase, FText>;
}