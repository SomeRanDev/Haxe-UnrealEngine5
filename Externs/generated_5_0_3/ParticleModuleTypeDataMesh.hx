...
extern class ParticleModuleTypeDataMesh extends ParticleModuleTypeDataBase {
	...
	public var MeshAlignment: TEnumAsByte<EMeshScreenAlignment>;
	...
	public var AxisLockOption: TEnumAsByte<EParticleAxisLock>;
	public var bCameraFacing: Bool;
	public var CameraFacingOption: TEnumAsByte<EMeshCameraFacingOptions>;
...
abstract ConstParticleModuleTypeDataMesh(ParticleModuleTypeDataMesh) from ParticleModuleTypeDataMesh {
	...
	public extern var MeshAlignment(get, never): TEnumAsByte<EMeshScreenAlignment>;
	public inline extern function get_MeshAlignment(): TEnumAsByte<EMeshScreenAlignment> return this.MeshAlignment;
	...
	public extern var AxisLockOption(get, never): TEnumAsByte<EParticleAxisLock>;
	public inline extern function get_AxisLockOption(): TEnumAsByte<EParticleAxisLock> return this.AxisLockOption;
	...
	public extern var CameraFacingOption(get, never): TEnumAsByte<EMeshCameraFacingOptions>;
	public inline extern function get_CameraFacingOption(): TEnumAsByte<EMeshCameraFacingOptions> return this.CameraFacingOption;
