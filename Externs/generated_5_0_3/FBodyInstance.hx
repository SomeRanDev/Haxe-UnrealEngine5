...
extern class FBodyInstance extends FBodyInstanceCore {
	...
	public var ResponseToChannels_DEPRECATED: FCollisionResponseContainer;
	...
	public var CollisionResponses: FCollisionResponse;
	...
	public var CustomDOFPlaneNormal: FVector;
	public var COMNudge: FVector;
	public var MassScale: cpp.Float32;
	public var InertiaTensorScale: FVector;
	public var WalkableSlopeOverride: FWalkableSlopeOverride;
	public var PhysMaterialOverride: TObjectPtr<UPhysicalMaterial>;
