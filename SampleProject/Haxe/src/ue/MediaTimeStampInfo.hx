...
extern class MediaTimeStampInfo extends Object {
	...
	public var SequenceIndex: ucpp.num.Int64;
...
abstract ConstMediaTimeStampInfo(MediaTimeStampInfo) from MediaTimeStampInfo {
	...
	public extern var SequenceIndex(get, never): ucpp.num.Int64;
	public inline extern function get_SequenceIndex(): ucpp.num.Int64 return this.SequenceIndex;
}

@:forward
@:nativeGen
@:native("MediaTimeStampInfo*")
abstract MediaTimeStampInfoPtr(ucpp.Ptr<MediaTimeStampInfo>) from ucpp.Ptr<MediaTimeStampInfo> to ucpp.Ptr<MediaTimeStampInfo>{
	@:from
