...
abstract AnimCurveCompressionCodecPtr(ucpp.Ptr<AnimCurveCompressionCodec>) from ucpp.Ptr<AnimCurveCompressionCodec> to ucpp.Ptr<AnimCurveCompressionCodec>{
	@:from
