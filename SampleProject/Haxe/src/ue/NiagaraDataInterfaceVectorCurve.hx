...
abstract NiagaraDataInterfaceVectorCurvePtr(ucpp.Ptr<NiagaraDataInterfaceVectorCurve>) from ucpp.Ptr<NiagaraDataInterfaceVectorCurve> to ucpp.Ptr<NiagaraDataInterfaceVectorCurve>{
	@:from
