...
abstract GizmoPlaneScaleParameterSourcePtr(ucpp.Ptr<GizmoPlaneScaleParameterSource>) from ucpp.Ptr<GizmoPlaneScaleParameterSource> to ucpp.Ptr<GizmoPlaneScaleParameterSource>{
	@:from
