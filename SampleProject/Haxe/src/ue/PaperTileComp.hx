...
extern class PaperTileComp extends MeshCompoComp {
	...
	public function GetTilePolygon(TileX: cpp.Int32, TileY: cpp.Int32, Points: cpp.Reference<TArray<FVector>>, LayerIndex: cpp.Int32, bWorldSpace: Bool): Void;
	public function GetTileMapColor(): cpp.Reference<FLinearColor>;
	public function GetTileCornerPosition(TileX: cpp.Int32, TileY: cpp.Int32, LayerIndex: cpp.Int32, bWorldSpace: Bool): cpp.Reference<FVector>;
	public function GetTileCenterPosition(TileX: cpp.Int32, TileY: cpp.Int32, LayerIndex: cpp.Int32, bWorldSpace: Bool): cpp.Reference<FVector>;
	public function GetTile(X: cpp.Int32, Y: cpp.Int32, Layer: cpp.Int32): cpp.Reference<FPaperTileInfo>;
	...
	public function GetLayerColor(Layer: cpp.Int32): cpp.Reference<FLinearColor>;
...
abstract ConstPaperTileComp(PaperTileComp) from PaperTileComp {
}