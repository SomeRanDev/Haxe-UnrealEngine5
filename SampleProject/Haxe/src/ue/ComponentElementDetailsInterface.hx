...
abstract ComponentElementDetailsInterfacePtr(ucpp.Ptr<ComponentElementDetailsInterface>) from ucpp.Ptr<ComponentElementDetailsInterface> to ucpp.Ptr<ComponentElementDetailsInterface>{
	@:from
