...
abstract CR_Mannequin_BasicFootIK_CPtr(ucpp.Ptr<CR_Mannequin_BasicFootIK_C>) from ucpp.Ptr<CR_Mannequin_BasicFootIK_C> to ucpp.Ptr<CR_Mannequin_BasicFootIK_C>{
	@:from
