...
extern class SkyAtmospComp extends SceneCompComp {
	...
	public function OverrideAtmosphereLightDirection(AtmosphereLightIndex: cpp.Int32, LightDirection: cpp.Reference<FVector>): Void;
	public function GetAtmosphereTransmitanceOnGroundAtPlanetTop(DirectionalLight: cpp.Star<DirectionComp>): cpp.Reference<FLinearColor>;
}

@:forward()
abstract ConstSkyAtmospComp(SkyAtmospComp) from SkyAtmospComp {
}