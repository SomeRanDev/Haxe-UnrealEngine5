...
abstract K2Node_InAppPurchaseQueryOwned2Ptr(ucpp.Ptr<K2Node_InAppPurchaseQueryOwned2>) from ucpp.Ptr<K2Node_InAppPurchaseQueryOwned2> to ucpp.Ptr<K2Node_InAppPurchaseQueryOwned2>{
	@:from
