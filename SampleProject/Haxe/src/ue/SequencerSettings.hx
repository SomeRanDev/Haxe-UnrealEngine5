...
abstract ConstSequencerSettings(SequencerSettings) from SequencerSettings {
	...
	public extern var bSnapPlayTimeToSections(get, never): Bool;
	public inline extern function get_bSnapPlayTimeToSections(): Bool return this.bSnapPlayTimeToSections;
	public extern var bSnapPlayTimeToMarkers(get, never): Bool;
	public inline extern function get_bSnapPlayTimeToMarkers(): Bool return this.bSnapPlayTimeToMarkers;
	...
	public extern var KeyAreaCurveExtents(get, never): FString;
	public inline extern function get_KeyAreaCurveExtents(): FString return this.KeyAreaCurveExtents;
	public extern var KeyAreaHeightWithCurves(get, never): cpp.Float32;
	public inline extern function get_KeyAreaHeightWithCurves(): cpp.Float32 return this.KeyAreaHeightWithCurves;
