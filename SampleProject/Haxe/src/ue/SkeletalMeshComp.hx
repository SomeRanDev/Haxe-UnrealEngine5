...
extern class SkeletalMeshComp extends SkinnedMeshComp {
	...
	public function GetTransformAttribute_Ref(BoneName: cpp.Reference<FName>, AttributeName: cpp.Reference<FName>, OutValue: cpp.Reference<Transform>, LookupType: ECustomBoneAttributeLookup): cpp.Reference<Bool>;
	public function GetTransformAttribute(BoneName: cpp.Reference<FName>, AttributeName: cpp.Reference<FName>, DefaultValue: Transform, OutValue: cpp.Reference<Transform>, LookupType: ECustomBoneAttributeLookup): cpp.Reference<Bool>;
	...
	public function GetConstraintByName(ConstraintName: FName, bIncludesTerminated: Bool): cpp.Reference<ConstraintInstanceAccessor>;
	...
	public function GetBoneLinearVelocity(InBoneName: cpp.Reference<FName>): cpp.Reference<Vector>;
...
abstract ConstSkeletalMeshComp(SkeletalMeshComp) from SkeletalMeshComp {
	...
	public extern var bOverrideDefaultAnimatingRig(get, never): Bool;
	public inline extern function get_bOverrideDefaultAnimatingRig(): Bool return this.bOverrideDefaultAnimatingRig;
