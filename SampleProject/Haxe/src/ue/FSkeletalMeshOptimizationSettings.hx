...
extern class FSkeletalMeshOptimizationSettings {
	...
	public var BonesToRemove_DEPRECATED: TArray<FBoneReference>;
	public var BakePose_DEPRECATED: TObjectPtr<UAnimSequence>;
}