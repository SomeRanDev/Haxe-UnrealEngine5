...
abstract PlaneTranslationDragOperationPtr(ucpp.Ptr<PlaneTranslationDragOperation>) from ucpp.Ptr<PlaneTranslationDragOperation> to ucpp.Ptr<PlaneTranslationDragOperation>{
	@:from
