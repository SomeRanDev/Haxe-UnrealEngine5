...
extern class UApplicationLifecycleComponent extends UActorComponent {
	...
	public function ApplicationStartupArgumentsDelegate__DelegateSignature(StartupArguments: TArray<FString>): Void;
