...
extern class ParticleModuleRequired extends ParticleModule {
	...
	public var SortMode: TEnumAsByte<EParticleSortMode>;
...
abstract ConstParticleModuleRequired(ParticleModuleRequired) from ParticleModuleRequired {
	...
	public extern var ScreenAlignment(get, never): TEnumAsByte<EParticleScreenAlignment>;
	public inline extern function get_ScreenAlignment(): TEnumAsByte<EParticleScreenAlignment> return this.ScreenAlignment;
	...
	public extern var SortMode(get, never): TEnumAsByte<EParticleSortMode>;
	public inline extern function get_SortMode(): TEnumAsByte<EParticleSortMode> return this.SortMode;
	...
	public inline extern function get_InterpolationMethod(): TEnumAsByte<EParticleSubUVInterpMethod> return this.InterpolationMethod;
	...
	public extern var EmitterNormalsMode(get, never): TEnumAsByte<EEmitterNormalsMode>;
