...
abstract ParticleModuleVectorFieldRotationRatePtr(ucpp.Ptr<ParticleModuleVectorFieldRotationRate>) from ucpp.Ptr<ParticleModuleVectorFieldRotationRate> to ucpp.Ptr<ParticleModuleVectorFieldRotationRate>{
	@:from
