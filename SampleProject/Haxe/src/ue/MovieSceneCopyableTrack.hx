...
abstract ConstMovieSceneCopyableTrack(MovieSceneCopyableTrack) from MovieSceneCopyableTrack {
	...
	public extern var bIsAMasterTrack(get, never): Bool;
	public inline extern function get_bIsAMasterTrack(): Bool return this.bIsAMasterTrack;
	public extern var bIsACameraCutTrack(get, never): Bool;
	public inline extern function get_bIsACameraCutTrack(): Bool return this.bIsACameraCutTrack;
