...
abstract NiagaraStackEmitterPropertiesItemPtr(ucpp.Ptr<NiagaraStackEmitterPropertiesItem>) from ucpp.Ptr<NiagaraStackEmitterPropertiesItem> to ucpp.Ptr<NiagaraStackEmitterPropertiesItem>{
	@:from
