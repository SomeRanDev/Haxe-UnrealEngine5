...
abstract SoundfieldEffectSettingsBasePtr(ucpp.Ptr<SoundfieldEffectSettingsBase>) from ucpp.Ptr<SoundfieldEffectSettingsBase> to ucpp.Ptr<SoundfieldEffectSettingsBase>{
	@:from
