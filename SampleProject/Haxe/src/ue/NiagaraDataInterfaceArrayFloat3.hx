...
abstract NiagaraDataInterfaceArrayFloat3Ptr(ucpp.Ptr<NiagaraDataInterfaceArrayFloat3>) from ucpp.Ptr<NiagaraDataInterfaceArrayFloat3> to ucpp.Ptr<NiagaraDataInterfaceArrayFloat3>{
	@:from
