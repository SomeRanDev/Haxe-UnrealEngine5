...
extern class FConstraintInstance extends FConstraintInstanceBase {
	public var JointName: FName;
	public var ConstraintBone1: FName;
	public var ConstraintBone2: FName;
	public var Pos1: FVector;
	public var PriAxis1: FVector;
	public var SecAxis1: FVector;
	public var Pos2: FVector;
	public var PriAxis2: FVector;
	public var SecAxis2: FVector;
	public var AngularRotationOffset: FRotator;
	public var bScaleLinearLimits: Bool;
	public var ProfileInstance: FConstraintProfileProperties;
	...
	public var LinearPositionTarget_DEPRECATED: FVector;
	public var LinearVelocityTarget_DEPRECATED: FVector;
	...
	public var AngularPositionTarget_DEPRECATED: FQuat;
	public var AngularDriveMode_DEPRECATED: EAngularDriveMode;
	public var AngularOrientationTarget_DEPRECATED: FRotator;
	public var AngularVelocityTarget_DEPRECATED: FVector;
