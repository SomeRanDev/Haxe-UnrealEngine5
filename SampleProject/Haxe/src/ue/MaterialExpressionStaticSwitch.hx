...
abstract MaterialExpressionStaticSwitchPtr(ucpp.Ptr<MaterialExpressionStaticSwitch>) from ucpp.Ptr<MaterialExpressionStaticSwitch> to ucpp.Ptr<MaterialExpressionStaticSwitch>{
	@:from
