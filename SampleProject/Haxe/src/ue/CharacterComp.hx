...
extern class CharacterComp extends PawnMovemComp {
	...
	public var DeferredUpdatedMoveComponent: cpp.Star<SceneCompComp>;
	...
	public function SetGroupsToIgnoreMask(GroupMask: cpp.Reference<FNavAvoidanceMask>): Void;
	public function SetGroupsToIgnore(GroupFlags: cpp.Int32): Void;
	public function SetGroupsToAvoidMask(GroupMask: cpp.Reference<FNavAvoidanceMask>): Void;
	...
	public function SetAvoidanceGroupMask(GroupMask: cpp.Reference<FNavAvoidanceMask>): Void;
	...
	public function K2_FindFloor(CapsuleLocation: FVector, FloorResult: cpp.Reference<FFindFloorResult>): Void;
	public function K2_ComputeFloorDist(CapsuleLocation: FVector, LineDistance: cpp.Float32, SweepDistance: cpp.Float32, SweepRadius: cpp.Float32, FloorResult: cpp.Reference<FFindFloorResult>): Void;
	public function IsWalking(): cpp.Reference<Bool>;
	public function IsWalkable(Hit: cpp.Reference<FHitResult>): cpp.Reference<Bool>;
	...
	public function GetLastUpdateVelocity(): cpp.Reference<FVector>;
	public function GetLastUpdateRotation(): cpp.Reference<FRotator>;
	public function GetLastUpdateLocation(): cpp.Reference<FVector>;
	public function GetImpartedMovementBaseVelocity(): cpp.Reference<FVector>;
	public function GetCurrentAcceleration(): cpp.Reference<FVector>;
	...
	public function CapsuleTouched(OverlappedComp: cpp.Star<PrimitiveComp>, Other: cpp.Star<Actor>, OtherComp: cpp.Star<PrimitiveComp>, OtherBodyIndex: cpp.Int32, bFromSweep: Bool, SweepResult: cpp.Reference<FHitResult>): Void;
...
abstract ConstCharacterComp(CharacterComp) from CharacterComp {
}