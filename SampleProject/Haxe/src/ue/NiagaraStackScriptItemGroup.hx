...
abstract NiagaraStackScriptItemGroupPtr(ucpp.Ptr<NiagaraStackScriptItemGroup>) from ucpp.Ptr<NiagaraStackScriptItemGroup> to ucpp.Ptr<NiagaraStackScriptItemGroup>{
	@:from
