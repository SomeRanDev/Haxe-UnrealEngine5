...
abstract MaterialExpressionArctangent2Ptr(ucpp.Ptr<MaterialExpressionArctangent2>) from ucpp.Ptr<MaterialExpressionArctangent2> to ucpp.Ptr<MaterialExpressionArctangent2>{
	@:from
