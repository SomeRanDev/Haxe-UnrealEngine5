...
extern class AISenseConfig_Hearing extends AISenseConfig {
	...
	public var HearingRange: ucpp.num.Float32;
	public var LoSHearingRange: ucpp.num.Float32;
...
abstract ConstAISenseConfig_Hearing(AISenseConfig_Hearing) from AISenseConfig_Hearing {
	...
	public extern var HearingRange(get, never): ucpp.num.Float32;
	public inline extern function get_HearingRange(): ucpp.num.Float32 return this.HearingRange;
	public extern var LoSHearingRange(get, never): ucpp.num.Float32;
	public inline extern function get_LoSHearingRange(): ucpp.num.Float32 return this.LoSHearingRange;
...
abstract AISenseConfig_HearingPtr(ucpp.Ptr<AISenseConfig_Hearing>) from ucpp.Ptr<AISenseConfig_Hearing> to ucpp.Ptr<AISenseConfig_Hearing>{
	@:from
