...
abstract ParticleModuleRotationRatePtr(ucpp.Ptr<ParticleModuleRotationRate>) from ucpp.Ptr<ParticleModuleRotationRate> to ucpp.Ptr<ParticleModuleRotationRate>{
	@:from
