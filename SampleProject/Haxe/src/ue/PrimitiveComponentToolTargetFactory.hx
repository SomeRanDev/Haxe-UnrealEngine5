...
abstract PrimitiveComponentToolTargetFactoryPtr(ucpp.Ptr<PrimitiveComponentToolTargetFactory>) from ucpp.Ptr<PrimitiveComponentToolTargetFactory> to ucpp.Ptr<PrimitiveComponentToolTargetFactory>{
	@:from
