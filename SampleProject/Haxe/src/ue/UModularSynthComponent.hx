...
extern class UModularSynthComponent extends USynthComponent {
	public var VoiceCount: cpp.Int32;

	public function SetSynthPreset(SynthPreset: FModularSynthPreset): Void;
	...
	public function SetEnablePatch(PatchId: FPatchId, bIsEnabled: Bool): Bool;
	...
	public function CreatePatch(PatchSource: ESynth1PatchSource, PatchCables: TArray<FSynth1PatchCable>, bEnableByDefault: Bool): FPatchId;
}
