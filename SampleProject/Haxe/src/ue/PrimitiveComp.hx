...
@:forward(
	...
	GetCustomPrimitiveDataIndexForVectorParameter, GetCustomPrimitiveDataIndexForScalarParameter, GetCollisionResponseToChannel, GetCollisionProfileName, GetCollisionObjectType,
	GetCollisionEnabled, GetClosestPointOnCollision, GetCenterOfMass, GetAngularDamping, CanCharacterStepUp
)
@:nativeGen
